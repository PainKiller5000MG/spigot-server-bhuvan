...
public class CollectToTag implements StreamTagVisitor {
    ...
    public StreamTagVisitor.ValueResult visitContainerEnd() {
        CollectToTag.ContainerBuilder collecttotag_containerbuilder = (CollectToTag.ContainerBuilder) this.containerStack.removeLast();
        Tag tag = collecttotag_containerbuilder.build();
