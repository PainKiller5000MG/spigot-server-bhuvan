...
public class SoundEvents {
    ...
    private static Holder<SoundEvent> register(Identifier id, Identifier soundId, float range) {
    ...
    private static ImmutableList<Holder.Reference<SoundEvent>> registerGoatHornSoundVariants() {
        return (ImmutableList) IntStream.range(0, 8).mapToObj((i) -> {
            return registerForHolder("item.goat_horn.sound." + i);
        }).collect(ImmutableList.toImmutableList());
    }

    private static Map<WolfSoundVariants.SoundSet, WolfSoundVariant> registerWolfSoundVariants() {
        return (Map) Stream.of(WolfSoundVariants.SoundSet.values()).collect(Collectors.toMap((wolfsoundvariants_soundset) -> {
            return wolfsoundvariants_soundset;
        }, (wolfsoundvariants_soundset) -> {
            String s = wolfsoundvariants_soundset.getSoundEventSuffix();

            return new WolfSoundVariant(registerForHolder("entity.wolf" + s + ".ambient"), registerForHolder("entity.wolf" + s + ".death"), registerForHolder("entity.wolf" + s + ".growl"), registerForHolder("entity.wolf" + s + ".hurt"), registerForHolder("entity.wolf" + s + ".pant"), registerForHolder("entity.wolf" + s + ".whine"));
        }));
    }
}
