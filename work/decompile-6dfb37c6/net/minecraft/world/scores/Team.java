...
public abstract class Team {
    ...
    public static enum Visibility implements StringRepresentable {
        ...
        public static final Codec<Team.Visibility> CODEC = StringRepresentable.<Team.Visibility>fromEnum(Team.Visibility::values);
        private static final IntFunction<Team.Visibility> BY_ID = ByIdMap.<Team.Visibility>continuous((team_visibility) -> {
            return team_visibility.id;
        }, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
        public static final StreamCodec<ByteBuf, Team.Visibility> STREAM_CODEC = ByteBufCodecs.idMapper(Team.Visibility.BY_ID, (team_visibility) -> {
            return team_visibility.id;
        });
    ...
    public static enum CollisionRule implements StringRepresentable {
        ...
        public static final Codec<Team.CollisionRule> CODEC = StringRepresentable.<Team.CollisionRule>fromEnum(Team.CollisionRule::values);
        private static final IntFunction<Team.CollisionRule> BY_ID = ByIdMap.<Team.CollisionRule>continuous((team_collisionrule) -> {
            return team_collisionrule.id;
        }, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
        public static final StreamCodec<ByteBuf, Team.CollisionRule> STREAM_CODEC = ByteBufCodecs.idMapper(Team.CollisionRule.BY_ID, (team_collisionrule) -> {
            return team_collisionrule.id;
        });
        public final String name;
        public final int id;
