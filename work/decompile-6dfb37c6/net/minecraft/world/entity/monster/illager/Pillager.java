...
public class Pillager extends AbstractIllager implements CrossbowAttackMob, InventoryCarrier {
    ...
    private static final EntityDataAccessor<Boolean> IS_CHARGING_CROSSBOW = SynchedEntityData.<Boolean>defineId(Pillager.class, EntityDataSerializers.BOOLEAN);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        ...
        entityData.define(Pillager.IS_CHARGING_CROSSBOW, false);
    }
    ...
    public void setChargingCrossbow(boolean isCharging) {
        this.entityData.set(Pillager.IS_CHARGING_CROSSBOW, isCharging);
    }
    ...
    public void applyRaidBuffs(ServerLevel level, int wave, boolean isCaptain) {
        ...
        if (flag1) {
            ...
            if (resourcekey != null) {
                EnchantmentHelper.enchantItemFromProvider(itemstack, level.registryAccess(), resourcekey, level.getCurrentDifficultyAt(this.blockPosition()), this.getRandom());
