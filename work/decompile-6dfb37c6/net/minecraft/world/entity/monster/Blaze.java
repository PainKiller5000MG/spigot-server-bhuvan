...
public class Blaze extends Monster {
    ...
    private static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.<Byte>defineId(Blaze.class, EntityDataSerializers.BYTE);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        ...
        entityData.define(Blaze.DATA_FLAGS_ID, (byte) 0);
    }
    ...
    private void setCharged(boolean value) {
        ...
        this.entityData.set(Blaze.DATA_FLAGS_ID, b0);
    }
            ...
            if (livingentity != null) {
                ...
                if (d0 < 4.0D) {
                    ...
                    if (this.attackTime <= 0) {
                        this.attackTime = 20;
                        this.blaze.doHurtTarget(getServerLevel((Entity) this.blaze), livingentity);
                    }
                    ...
                    if (this.attackTime <= 0) {
                        ...
                        if (this.attackStep > 1) {
                            ...
                            for (int i = 0; i < 1; ++i) {
                                Vec3 vec3 = new Vec3(this.blaze.getRandom().triangle(d1, 2.297D * d4), d2, this.blaze.getRandom().triangle(d3, 2.297D * d4));
