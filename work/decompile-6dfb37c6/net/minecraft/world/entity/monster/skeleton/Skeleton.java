...
public class Skeleton extends AbstractSkeleton {
    ...
    public static final EntityDataAccessor<Boolean> DATA_STRAY_CONVERSION_ID = SynchedEntityData.<Boolean>defineId(Skeleton.class, EntityDataSerializers.BOOLEAN);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        ...
        entityData.define(Skeleton.DATA_STRAY_CONVERSION_ID, false);
    }
    ...
    public void setFreezeConverting(boolean isConverting) {
        this.entityData.set(Skeleton.DATA_STRAY_CONVERSION_ID, isConverting);
    }
    ...
    protected void readAdditionalSaveData(ValueInput input) {
        ...
        int i = input.getIntOr("StrayConversionTime", -1);
