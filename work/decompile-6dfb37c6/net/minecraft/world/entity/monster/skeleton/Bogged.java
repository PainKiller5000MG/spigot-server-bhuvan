...
public class Bogged extends AbstractSkeleton implements Shearable {
    ...
    private static final EntityDataAccessor<Boolean> DATA_SHEARED = SynchedEntityData.<Boolean>defineId(Bogged.class, EntityDataSerializers.BOOLEAN);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        ...
        entityData.define(Bogged.DATA_SHEARED, false);
    }
    ...
    public void shear(ServerLevel level, SoundSource soundSource, ItemStack tool) {
        level.playSound((Entity) null, (Entity) this, SoundEvents.BOGGED_SHEAR, soundSource, 1.0F, 1.0F);
        this.spawnShearedMushrooms(level, tool);
        this.setSheared(true);
    }

    private void spawnShearedMushrooms(ServerLevel level, ItemStack tool) {
        this.dropFromShearingLootTable(level, BuiltInLootTables.BOGGED_SHEAR, tool, (serverlevel1, itemstack1) -> {
            this.spawnAtLocation(serverlevel1, itemstack1, this.getBbHeight());
        });
    }
