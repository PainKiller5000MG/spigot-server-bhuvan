...
public class Slime extends Mob implements Enemy {
    ...
    private static final EntityDataAccessor<Integer> ID_SIZE = SynchedEntityData.<Integer>defineId(Slime.class, EntityDataSerializers.INT);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        ...
        entityData.define(Slime.ID_SIZE, 1);
    }
    ...
    public void tick() {
        ...
        if (this.onGround() && !this.wasOnGround) {
            ...
            for (int i = 0; (float) i < f * 16.0F; ++i) {
                ...
                float f4 = Mth.sin((double) f2) * f1 * f3;
                float f5 = Mth.cos((double) f2) * f1 * f3;
    ...
    public void onSyncedDataUpdated(EntityDataAccessor<?> accessor) {
        if (Slime.ID_SIZE.equals(accessor)) {
            this.refreshDimensions();
        ...
        if (!this.level().isClientSide() && i > 1 && this.isDeadOrDying()) {
            ...
            for (int l = 0; l < k; ++l) {
                ...
                this.convertTo(this.getType(), new ConversionParams(ConversionType.SPLIT_ON_DEATH, false, false, playerteam), EntitySpawnReason.TRIGGERED, (slime) -> {
                    ...
                    slime.snapTo(this.getX() + (double) f2, this.getY() + 0.5D, this.getZ() + (double) f3, this.random.nextFloat() * 360.0F, 0.0F);
                });
            }
        }
    ...
    protected Vec3 getPassengerAttachmentPoint(Entity passenger, EntityDimensions dimensions, float scale) {
        return new Vec3(0.0D, (double) dimensions.height() - 0.015625D * (double) this.getSize() * (double) scale, 0.0D);
    }
    ...
    private static class SlimeAttackGoal extends Goal {
        ...
        public void tick() {
            ...
            if (movecontrol instanceof Slime.SlimeMoveControl slime_slimemovecontrol) {
