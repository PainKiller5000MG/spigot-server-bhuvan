...
public class Hoglin extends Animal implements Enemy, HoglinBase {
    ...
    private static final EntityDataAccessor<Boolean> DATA_IMMUNE_TO_ZOMBIFICATION = SynchedEntityData.<Boolean>defineId(Hoglin.class, EntityDataSerializers.BOOLEAN);
    ...
    protected Brain.Provider<Hoglin> brainProvider() {
        return Brain.<Hoglin>provider(Hoglin.MEMORY_TYPES, Hoglin.SENSOR_TYPES);
    }
    ...
    public float getWalkTargetValue(BlockPos pos, LevelReader level) {
        return HoglinAi.isPosNearNearestRepellent(this, pos) ? -1.0F : (level.getBlockState(pos.below()).is(Blocks.CRIMSON_NYLIUM) ? 10.0F : 0.0F);
    }
    ...
    private void finishConversion() {
        this.convertTo(EntityType.ZOGLIN, ConversionParams.single(this, true, false), (zoglin) -> {
            zoglin.addEffect(new MobEffectInstance(MobEffects.NAUSEA, 200, 0));
        });
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        ...
        entityData.define(Hoglin.DATA_IMMUNE_TO_ZOMBIFICATION, false);
    }
    ...
    public void setImmuneToZombification(boolean isImmuneToZombification) {
        this.getEntityData().set(Hoglin.DATA_IMMUNE_TO_ZOMBIFICATION, isImmuneToZombification);
    }
