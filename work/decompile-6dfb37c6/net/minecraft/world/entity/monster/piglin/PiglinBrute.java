...
public class PiglinBrute extends AbstractPiglin {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes().add(Attributes.MAX_HEALTH, 50.0D).add(Attributes.MOVEMENT_SPEED, (double) 0.35F).add(Attributes.ATTACK_DAMAGE, 7.0D).add(Attributes.FOLLOW_RANGE, 12.0D);
    }
    ...
    protected Brain.Provider<PiglinBrute> brainProvider() {
        return Brain.<PiglinBrute>provider(PiglinBrute.MEMORY_TYPES, PiglinBrute.SENSOR_TYPES);
    }
