...
public abstract class AbstractPiglin extends Monster {
    ...
    protected static final EntityDataAccessor<Boolean> DATA_IMMUNE_TO_ZOMBIFICATION = SynchedEntityData.<Boolean>defineId(AbstractPiglin.class, EntityDataSerializers.BOOLEAN);
    ...
    public void setImmuneToZombification(boolean isImmuneToZombification) {
        this.getEntityData().set(AbstractPiglin.DATA_IMMUNE_TO_ZOMBIFICATION, isImmuneToZombification);
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        ...
        entityData.define(AbstractPiglin.DATA_IMMUNE_TO_ZOMBIFICATION, false);
    }
    ...
    protected void finishConversion(ServerLevel level) {
        this.convertTo(EntityType.ZOMBIFIED_PIGLIN, ConversionParams.single(this, true, true), (zombifiedpiglin) -> {
            zombifiedpiglin.addEffect(new MobEffectInstance(MobEffects.NAUSEA, 200, 0));
        });
    }
