...
public class InterpolationHandler {
    ...
    public void interpolate() {
        if (!this.hasActiveInterpolation()) {
            ...
            double d1 = Mth.lerp(d0, this.entity.getX(), this.interpolationData.position.x);
            double d2 = Mth.lerp(d0, this.entity.getY(), this.interpolationData.position.y);
            double d3 = Mth.lerp(d0, this.entity.getZ(), this.interpolationData.position.z);
            Vec3 vec31 = new Vec3(d1, d2, d3);
            float f2 = (float) Mth.rotLerp(d0, (double) this.entity.getYRot(), (double) this.interpolationData.yRot);
            float f3 = (float) Mth.lerp(d0, (double) this.entity.getXRot(), (double) this.interpolationData.xRot);
