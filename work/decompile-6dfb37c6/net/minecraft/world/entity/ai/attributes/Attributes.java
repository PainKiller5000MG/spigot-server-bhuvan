...
public class Attributes {
    ...
    public static final Holder<Attribute> BURNING_TIME = register("burning_time", (new RangedAttribute("attribute.name.burning_time", 1.0D, 0.0D, 1024.0D)).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
    public static final Holder<Attribute> CAMERA_DISTANCE = register("camera_distance", (new RangedAttribute("attribute.name.camera_distance", 4.0D, 0.0D, 32.0D)).setSyncable(true));
    public static final Holder<Attribute> EXPLOSION_KNOCKBACK_RESISTANCE = register("explosion_knockback_resistance", (new RangedAttribute("attribute.name.explosion_knockback_resistance", 0.0D, 0.0D, 1.0D)).setSyncable(true));
    public static final Holder<Attribute> ENTITY_INTERACTION_RANGE = register("entity_interaction_range", (new RangedAttribute("attribute.name.entity_interaction_range", 3.0D, 0.0D, 64.0D)).setSyncable(true));
    public static final Holder<Attribute> FALL_DAMAGE_MULTIPLIER = register("fall_damage_multiplier", (new RangedAttribute("attribute.name.fall_damage_multiplier", 1.0D, 0.0D, 100.0D)).setSyncable(true).setSentiment(Attribute.Sentiment.NEGATIVE));
    public static final Holder<Attribute> FLYING_SPEED = register("flying_speed", (new RangedAttribute("attribute.name.flying_speed", 0.4D, 0.0D, 1024.0D)).setSyncable(true));
    public static final Holder<Attribute> FOLLOW_RANGE = register("follow_range", new RangedAttribute("attribute.name.follow_range", 32.0D, 0.0D, 2048.0D));
    public static final Holder<Attribute> GRAVITY = register("gravity", (new RangedAttribute("attribute.name.gravity", 0.08D, -1.0D, 1.0D)).setSyncable(true).setSentiment(Attribute.Sentiment.NEUTRAL));
    ...
    public static final Holder<Attribute> SNEAKING_SPEED = register("sneaking_speed", (new RangedAttribute("attribute.name.sneaking_speed", 0.3D, 0.0D, 1.0D)).setSyncable(true));
    public static final Holder<Attribute> SPAWN_REINFORCEMENTS_CHANCE = register("spawn_reinforcements", new RangedAttribute("attribute.name.spawn_reinforcements", 0.0D, 0.0D, 1.0D));
    public static final Holder<Attribute> STEP_HEIGHT = register("step_height", (new RangedAttribute("attribute.name.step_height", 0.6D, 0.0D, 10.0D)).setSyncable(true));
    public static final Holder<Attribute> SUBMERGED_MINING_SPEED = register("submerged_mining_speed", (new RangedAttribute("attribute.name.submerged_mining_speed", 0.2D, 0.0D, 20.0D)).setSyncable(true));
    public static final Holder<Attribute> SWEEPING_DAMAGE_RATIO = register("sweeping_damage_ratio", (new RangedAttribute("attribute.name.sweeping_damage_ratio", 0.0D, 0.0D, 1.0D)).setSyncable(true));
    public static final Holder<Attribute> TEMPT_RANGE = register("tempt_range", new RangedAttribute("attribute.name.tempt_range", 10.0D, 0.0D, 2048.0D));
    public static final Holder<Attribute> WATER_MOVEMENT_EFFICIENCY = register("water_movement_efficiency", (new RangedAttribute("attribute.name.water_movement_efficiency", 0.0D, 0.0D, 1.0D)).setSyncable(true));
    public static final Holder<Attribute> WAYPOINT_TRANSMIT_RANGE = register("waypoint_transmit_range", (new RangedAttribute("attribute.name.waypoint_transmit_range", 0.0D, 0.0D, 6.0E7D)).setSentiment(Attribute.Sentiment.NEUTRAL));
    public static final Holder<Attribute> WAYPOINT_RECEIVE_RANGE = register("waypoint_receive_range", (new RangedAttribute("attribute.name.waypoint_receive_range", 0.0D, 0.0D, 6.0E7D)).setSentiment(Attribute.Sentiment.NEUTRAL));
