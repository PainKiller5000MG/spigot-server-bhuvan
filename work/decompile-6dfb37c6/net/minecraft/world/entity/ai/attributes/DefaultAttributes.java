...
public class DefaultAttributes {
    ...
    public static void validate() {
        ...
        stream.map(defaultedregistry::getKey).forEach((identifier) -> {
            Util.logAndPauseIfInIde("Entity " + String.valueOf(identifier) + " has no attributes");
        });
    }
}
