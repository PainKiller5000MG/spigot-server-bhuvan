...
public class SensorType<U extends Sensor<?>> {
    ...
    public static final SensorType<TemptingSensor> NAUTILUS_TEMPTATIONS = register("nautilus_temptations", () -> {
        return new TemptingSensor(NautilusAi.getTemptations());
    });
    ...
    private static <U extends Sensor<?>> SensorType<U> register(String name, Supplier<U> factory) {
        return (SensorType) Registry.register(BuiltInRegistries.SENSOR_TYPE, Identifier.withDefaultNamespace(name), new SensorType(factory));
    }
}
