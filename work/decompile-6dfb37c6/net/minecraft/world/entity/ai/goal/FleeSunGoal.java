...
public class FleeSunGoal extends Goal {
    ...
    public boolean canUse() {
        return this.mob.getTarget() != null ? false : (!this.level.isBrightOutside() ? false : (!this.mob.isOnFire() ? false : (!this.level.canSeeSky(this.mob.blockPosition()) ? false : (!this.mob.getItemBySlot(EquipmentSlot.HEAD).isEmpty() ? false : this.setWantedPos()))));
    }
