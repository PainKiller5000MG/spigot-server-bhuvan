...
public class PanicGoal extends Goal {
    ...
    public PanicGoal(PathfinderMob mob, double speedModifier, TagKey<DamageType> panicCausingDamageTypes) {
        this(mob, speedModifier, (pathfindermob1) -> {
            return panicCausingDamageTypes;
        });
    }
    ...
    protected @Nullable BlockPos lookForWater(BlockGetter level, Entity mob, int xzDist) {
        ...
        return !level.getBlockState(blockpos).getCollisionShape(level, blockpos).isEmpty() ? null : (BlockPos) BlockPos.findClosestMatch(mob.blockPosition(), xzDist, 1, (blockpos1) -> {
