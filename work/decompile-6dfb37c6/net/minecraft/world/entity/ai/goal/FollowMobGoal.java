...
public class FollowMobGoal extends Goal {
    ...
    public FollowMobGoal(Mob mob, double speedModifier, float stopDistance, float areaSize) {
        this.mob = mob;
        this.followPredicate = (mob1) -> {
            return mob.getClass() != mob1.getClass();
        };
    ...
    public boolean canUse() {
        List<Mob> list = this.mob.level().<Mob>getEntitiesOfClass(Mob.class, this.mob.getBoundingBox().inflate((double) this.areaSize), this.followPredicate);
