...
public class GoalUtils {
    ...
    public static boolean mobRestricted(PathfinderMob mob, double horizontalDist) {
        return mob.hasHome() && mob.getHomePosition().closerToCenterThan(mob.position(), (double) mob.getHomeRadius() + horizontalDist + 1.0D);
    }
    ...
    public static boolean hasMalus(PathfinderMob mob, BlockPos pos) {
        return mob.getPathfindingMalus(WalkNodeEvaluator.getPathTypeStatic((Mob) mob, pos)) != 0.0F;
    }
