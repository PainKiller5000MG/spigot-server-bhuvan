    ...
    public boolean isVisibleBy(LivingEntity body) {
        ...
        if (entity instanceof LivingEntity livingentity1) {
            if (!livingentity1.isAlive()) {
                ...
                Optional<NearestVisibleLivingEntities> optional = body.getBrain().<NearestVisibleLivingEntities>getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES);

                return optional.isPresent() && ((NearestVisibleLivingEntities) optional.get()).contains(livingentity1);
            }
        } else {
            return true;
        }
