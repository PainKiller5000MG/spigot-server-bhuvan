...
public record WolfVariant(WolfVariant.AssetInfo assetInfo, SpawnPrioritySelectors spawnConditions) implements PriorityProvider<SpawnContext, SpawnCondition> {
    ...
    public static final Codec<WolfVariant> DIRECT_CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(WolfVariant.AssetInfo.CODEC.fieldOf("assets").forGetter(WolfVariant::assetInfo), SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(WolfVariant::spawnConditions)).apply(instance, WolfVariant::new);
    });
    public static final Codec<WolfVariant> NETWORK_CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(WolfVariant.AssetInfo.CODEC.fieldOf("assets").forGetter(WolfVariant::assetInfo)).apply(instance, WolfVariant::new);
    });
    ...
    public static record AssetInfo(ClientAsset.ResourceTexture wild, ClientAsset.ResourceTexture tame, ClientAsset.ResourceTexture angry) {
        ...
        public static final Codec<WolfVariant.AssetInfo> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(ClientAsset.ResourceTexture.CODEC.fieldOf("wild").forGetter(WolfVariant.AssetInfo::wild), ClientAsset.ResourceTexture.CODEC.fieldOf("tame").forGetter(WolfVariant.AssetInfo::tame), ClientAsset.ResourceTexture.CODEC.fieldOf("angry").forGetter(WolfVariant.AssetInfo::angry)).apply(instance, WolfVariant.AssetInfo::new);
        });
    }
}
