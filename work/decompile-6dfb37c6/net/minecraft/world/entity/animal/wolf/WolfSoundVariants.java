...
public class WolfSoundVariants {
    ...
    private static ResourceKey<WolfSoundVariant> createKey(WolfSoundVariants.SoundSet wolfSoundVariant) {
    ...
    public static void bootstrap(BootstrapContext<WolfSoundVariant> context) {
        register(context, WolfSoundVariants.CLASSIC, WolfSoundVariants.SoundSet.CLASSIC);
        register(context, WolfSoundVariants.PUGLIN, WolfSoundVariants.SoundSet.PUGLIN);
        register(context, WolfSoundVariants.SAD, WolfSoundVariants.SoundSet.SAD);
        register(context, WolfSoundVariants.ANGRY, WolfSoundVariants.SoundSet.ANGRY);
        register(context, WolfSoundVariants.GRUMPY, WolfSoundVariants.SoundSet.GRUMPY);
        register(context, WolfSoundVariants.BIG, WolfSoundVariants.SoundSet.BIG);
        register(context, WolfSoundVariants.CUTE, WolfSoundVariants.SoundSet.CUTE);
    }

    private static void register(BootstrapContext<WolfSoundVariant> context, ResourceKey<WolfSoundVariant> key, WolfSoundVariants.SoundSet wolfSoundVariant) {
    ...
    public static enum SoundSet {
        ...
        private SoundSet(String identifier, String suffix) {
