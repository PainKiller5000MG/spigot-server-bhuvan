...
public class GlowSquid extends Squid {
    ...
    private static final EntityDataAccessor<Integer> DATA_DARK_TICKS_REMAINING = SynchedEntityData.<Integer>defineId(GlowSquid.class, EntityDataSerializers.INT);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        ...
        entityData.define(GlowSquid.DATA_DARK_TICKS_REMAINING, 0);
    }
    ...
    public void setDarkTicks(int ticks) {
        this.entityData.set(GlowSquid.DATA_DARK_TICKS_REMAINING, ticks);
    }
