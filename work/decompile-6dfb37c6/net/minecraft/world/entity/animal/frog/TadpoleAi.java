...
public class TadpoleAi {
    ...
    private static void initIdleActivity(Brain<Tadpole> brain) {
        brain.addActivity(Activity.IDLE, ImmutableList.of(Pair.of(0, SetEntityLookTargetSometimes.create(EntityType.PLAYER, 6.0F, UniformInt.of(30, 60))), Pair.of(1, new FollowTemptation((livingentity) -> {
            return 1.25F;
