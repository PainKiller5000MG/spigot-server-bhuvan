...
public record ChickenVariant(ModelAndTexture<ChickenVariant.ModelType> modelAndTexture, SpawnPrioritySelectors spawnConditions) implements PriorityProvider<SpawnContext, SpawnCondition> {
    ...
    public static final Codec<ChickenVariant> DIRECT_CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ModelAndTexture.codec(ChickenVariant.ModelType.CODEC, ChickenVariant.ModelType.NORMAL).forGetter(ChickenVariant::modelAndTexture), SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(ChickenVariant::spawnConditions)).apply(instance, ChickenVariant::new);
    });
    public static final Codec<ChickenVariant> NETWORK_CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ModelAndTexture.codec(ChickenVariant.ModelType.CODEC, ChickenVariant.ModelType.NORMAL).forGetter(ChickenVariant::modelAndTexture)).apply(instance, ChickenVariant::new);
    });
    ...
    private ChickenVariant(ModelAndTexture<ChickenVariant.ModelType> assetInfo) {
    ...
    public static enum ModelType implements StringRepresentable {
        ...
        public static final Codec<ChickenVariant.ModelType> CODEC = StringRepresentable.<ChickenVariant.ModelType>fromEnum(ChickenVariant.ModelType::values);
