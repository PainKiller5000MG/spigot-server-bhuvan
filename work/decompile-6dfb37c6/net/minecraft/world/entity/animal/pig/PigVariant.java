...
public record PigVariant(ModelAndTexture<PigVariant.ModelType> modelAndTexture, SpawnPrioritySelectors spawnConditions) implements PriorityProvider<SpawnContext, SpawnCondition> {
    ...
    public static final Codec<PigVariant> DIRECT_CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ModelAndTexture.codec(PigVariant.ModelType.CODEC, PigVariant.ModelType.NORMAL).forGetter(PigVariant::modelAndTexture), SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(PigVariant::spawnConditions)).apply(instance, PigVariant::new);
    });
    public static final Codec<PigVariant> NETWORK_CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ModelAndTexture.codec(PigVariant.ModelType.CODEC, PigVariant.ModelType.NORMAL).forGetter(PigVariant::modelAndTexture)).apply(instance, PigVariant::new);
    });
    ...
    private PigVariant(ModelAndTexture<PigVariant.ModelType> assetInfo) {
    ...
    public static enum ModelType implements StringRepresentable {
        ...
        public static final Codec<PigVariant.ModelType> CODEC = StringRepresentable.<PigVariant.ModelType>fromEnum(PigVariant.ModelType::values);
