...
public class PolarBear extends Animal implements NeutralMob {
    ...
    private static final EntityDataAccessor<Boolean> DATA_STANDING_ID = SynchedEntityData.<Boolean>defineId(PolarBear.class, EntityDataSerializers.BOOLEAN);
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Animal.createAnimalAttributes().add(Attributes.MAX_HEALTH, 30.0D).add(Attributes.FOLLOW_RANGE, 20.0D).add(Attributes.MOVEMENT_SPEED, 0.25D).add(Attributes.ATTACK_DAMAGE, 6.0D);
    }
    ...
    public static boolean checkPolarBearSpawnRules(EntityType<PolarBear> type, LevelAccessor level, EntitySpawnReason spawnReason, BlockPos pos, RandomSource random) {
        ...
        return !holder.is(BiomeTags.POLAR_BEARS_SPAWN_ON_ALTERNATE_BLOCKS) ? checkAnimalSpawnRules(type, level, spawnReason, pos, random) : isBrightEnoughToSpawn(level, pos) && level.getBlockState(pos.below()).is(BlockTags.POLAR_BEARS_SPAWNABLE_ON_ALTERNATE);
    }
    ...
    public void startPersistentAngerTimer() {
        this.setTimeToRemainAngry((long) PolarBear.PERSISTENT_ANGER_TIME.sample(this.random));
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        ...
        entityData.define(PolarBear.DATA_STANDING_ID, false);
    }
    ...
    public boolean isStanding() {
        return (Boolean) this.entityData.get(PolarBear.DATA_STANDING_ID);
    }

    public void setStanding(boolean value) {
        this.entityData.set(PolarBear.DATA_STANDING_ID, value);
    }
