...
public abstract class AbstractCow extends Animal {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Animal.createAnimalAttributes().add(Attributes.MAX_HEALTH, 10.0D).add(Attributes.MOVEMENT_SPEED, (double) 0.2F);
    }
    ...
    public EntityDimensions getDefaultDimensions(Pose pose) {
        return this.isBaby() ? AbstractCow.BABY_DIMENSIONS : super.getDefaultDimensions(pose);
    }
}
