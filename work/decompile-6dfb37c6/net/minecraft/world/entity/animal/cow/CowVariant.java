...
public record CowVariant(ModelAndTexture<CowVariant.ModelType> modelAndTexture, SpawnPrioritySelectors spawnConditions) implements PriorityProvider<SpawnContext, SpawnCondition> {
    ...
    public static final Codec<CowVariant> DIRECT_CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ModelAndTexture.codec(CowVariant.ModelType.CODEC, CowVariant.ModelType.NORMAL).forGetter(CowVariant::modelAndTexture), SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(CowVariant::spawnConditions)).apply(instance, CowVariant::new);
    });
    public static final Codec<CowVariant> NETWORK_CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ModelAndTexture.codec(CowVariant.ModelType.CODEC, CowVariant.ModelType.NORMAL).forGetter(CowVariant::modelAndTexture)).apply(instance, CowVariant::new);
    });
    ...
    private CowVariant(ModelAndTexture<CowVariant.ModelType> assetInfo) {
    ...
    public static enum ModelType implements StringRepresentable {
        ...
        public static final Codec<CowVariant.ModelType> CODEC = StringRepresentable.<CowVariant.ModelType>fromEnum(CowVariant.ModelType::values);
