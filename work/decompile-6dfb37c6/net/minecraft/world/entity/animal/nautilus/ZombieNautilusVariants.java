...
public class ZombieNautilusVariants {
    ...
    public static final ResourceKey<ZombieNautilusVariant> DEFAULT = ZombieNautilusVariants.TEMPERATE;
    ...
    public static void bootstrap(BootstrapContext<ZombieNautilusVariant> context) {
        register(context, ZombieNautilusVariants.TEMPERATE, ZombieNautilusVariant.ModelType.NORMAL, "zombie_nautilus", SpawnPrioritySelectors.fallback(0));
        register(context, ZombieNautilusVariants.WARM, ZombieNautilusVariant.ModelType.WARM, "zombie_nautilus_coral", BiomeTags.SPAWNS_CORAL_VARIANT_ZOMBIE_NAUTILUS);
    }
    ...
    private static void register(BootstrapContext<ZombieNautilusVariant> context, ResourceKey<ZombieNautilusVariant> name, ZombieNautilusVariant.ModelType modelType, String textureName, SpawnPrioritySelectors selectors) {
        ...
        context.register(name, new ZombieNautilusVariant(new ModelAndTexture(modelType, identifier), selectors));
    }
}
