...
public class Armadillo extends Animal {
    ...
    private static final EntityDataAccessor<Armadillo.ArmadilloState> ARMADILLO_STATE = SynchedEntityData.<Armadillo.ArmadilloState>defineId(Armadillo.class, EntityDataSerializers.ARMADILLO_STATE);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        ...
        entityData.define(Armadillo.ARMADILLO_STATE, Armadillo.ArmadilloState.IDLE);
    }
    ...
    public void onSyncedDataUpdated(EntityDataAccessor<?> accessor) {
        if (Armadillo.ARMADILLO_STATE.equals(accessor)) {
    ...
    public boolean isScaredBy(LivingEntity livingEntity) {
        if (!this.getBoundingBox().inflate(7.0D, 2.0D, 7.0D).intersects(livingEntity.getBoundingBox())) {
            return false;
    ...
    protected void readAdditionalSaveData(ValueInput input) {
        ...
        input.getInt("scute_time").ifPresent((integer) -> {
    ...
    public boolean brushOffScute(@Nullable Entity interactingEntity, ItemStack tool) {
        if (this.isBaby()) {
            ...
            if (level instanceof ServerLevel) {
                ...
                this.dropFromEntityInteractLootTable(serverlevel, BuiltInLootTables.ARMADILLO_BRUSH, interactingEntity, tool, this::spawnAtLocation);
    ...
    public static enum ArmadilloState implements StringRepresentable {
        ...
        private static final Codec<Armadillo.ArmadilloState> CODEC = StringRepresentable.<Armadillo.ArmadilloState>fromEnum(Armadillo.ArmadilloState::values);
        private static final IntFunction<Armadillo.ArmadilloState> BY_ID = ByIdMap.<Armadillo.ArmadilloState>continuous(Armadillo.ArmadilloState::id, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
