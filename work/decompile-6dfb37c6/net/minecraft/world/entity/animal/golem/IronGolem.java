...
public class IronGolem extends AbstractGolem implements NeutralMob {
    ...
    protected static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.<Byte>defineId(IronGolem.class, EntityDataSerializers.BYTE);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        ...
        entityData.define(IronGolem.DATA_FLAGS_ID, (byte) 0);
    }
    ...
    public boolean canAttackType(EntityType<?> targetType) {
        return this.isPlayerCreated() && targetType == EntityType.PLAYER ? false : (targetType == EntityType.CREEPER ? false : super.canAttackType(targetType));
    }
    ...
    public void startPersistentAngerTimer() {
        this.setTimeToRemainAngry((long) IronGolem.PERSISTENT_ANGER_TIME.sample(this.random));
    }
    ...
    public boolean doHurtTarget(ServerLevel level, Entity target) {
        ...
        if (flag) {
            ...
            target.setDeltaMovement(target.getDeltaMovement().add(0.0D, (double) 0.4F * d2, 0.0D));
    ...
    public boolean hurtServer(ServerLevel level, DamageSource source, float damage) {
        Crackiness.Level crackiness_level = this.getCrackiness();
        boolean flag = super.hurtServer(level, source, damage);

        if (flag && this.getCrackiness() != crackiness_level) {
