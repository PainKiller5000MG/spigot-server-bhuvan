...
public abstract class ThrowableItemProjectile extends ThrowableProjectile implements ItemSupplier {
    ...
    private static final EntityDataAccessor<ItemStack> DATA_ITEM_STACK = SynchedEntityData.<ItemStack>defineId(ThrowableItemProjectile.class, EntityDataSerializers.ITEM_STACK);
    ...
    public void setItem(ItemStack source) {
        this.getEntityData().set(ThrowableItemProjectile.DATA_ITEM_STACK, source.copyWithCount(1));
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        entityData.define(ThrowableItemProjectile.DATA_ITEM_STACK, new ItemStack(this.getDefaultItem()));
    }
    ...
    protected void readAdditionalSaveData(ValueInput input) {
        ...
        this.setItem((ItemStack) input.read("Item", ItemStack.CODEC).orElseGet(() -> {
