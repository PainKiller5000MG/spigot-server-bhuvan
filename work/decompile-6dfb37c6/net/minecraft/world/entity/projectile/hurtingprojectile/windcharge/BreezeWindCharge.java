...
public class BreezeWindCharge extends AbstractWindCharge {
    ...
    public void explode(Vec3 position) {
        this.level().explode(this, (DamageSource) null, BreezeWindCharge.EXPLOSION_DAMAGE_CALCULATOR, position.x(), position.y(), position.z(), 3.0F, false, Level.ExplosionInteraction.TRIGGER, ParticleTypes.GUST_EMITTER_SMALL, ParticleTypes.GUST_EMITTER_LARGE, WeightedList.of(), SoundEvents.BREEZE_WIND_CHARGE_BURST);
    }
}
