...
public class DragonLandingApproachPhase extends AbstractDragonPhaseInstance {
    ...
    private void findNewTarget(ServerLevel level) {
        if (this.currentPath == null || this.currentPath.isDone()) {
            ...
            Player player = level.getNearestPlayer(DragonLandingApproachPhase.NEAR_EGG_TARGETING, this.dragon, (double) blockpos.getX(), (double) blockpos.getY(), (double) blockpos.getZ());
            int j;
