            ...
            if (this.attackTarget.distanceToSqr((Entity) this.dragon) < 4096.0D) {
                if (this.dragon.hasLineOfSight(this.attackTarget)) {
                    ...
                    if (this.fireballCharge >= 5 && f1 >= 0.0F && f1 < 10.0F) {
                        ...
                        Vec3 vec33 = new Vec3(d12, d13, d14);

                        if (!this.dragon.isSilent()) {
                            level.levelEvent((Entity) null, 1017, this.dragon.blockPosition(), 0);
                        }

                        DragonFireball dragonfireball = new DragonFireball(level, this.dragon, vec33.normalize());

                        dragonfireball.snapTo(d9, d10, d11, 0.0F, 0.0F);
