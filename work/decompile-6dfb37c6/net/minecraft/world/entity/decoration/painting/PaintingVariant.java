...
public record PaintingVariant(int width, int height, Identifier assetId, Optional<Component> title, Optional<Component> author) {
    ...
    public static final Codec<Holder<PaintingVariant>> CODEC = RegistryFixedCodec.<Holder<PaintingVariant>>create(Registries.PAINTING_VARIANT);
