...
public enum EquipmentSlot implements StringRepresentable {
    ...
    MAINHAND(EquipmentSlot.Type.HAND, 0, 0, "mainhand"), OFFHAND(EquipmentSlot.Type.HAND, 1, 5, "offhand"), FEET(EquipmentSlot.Type.HUMANOID_ARMOR, 0, 1, 1, "feet"), LEGS(EquipmentSlot.Type.HUMANOID_ARMOR, 1, 1, 2, "legs"), CHEST(EquipmentSlot.Type.HUMANOID_ARMOR, 2, 1, 3, "chest"), HEAD(EquipmentSlot.Type.HUMANOID_ARMOR, 3, 1, 4, "head"), BODY(EquipmentSlot.Type.ANIMAL_ARMOR, 0, 1, 6, "body"), SADDLE(EquipmentSlot.Type.SADDLE, 0, 1, 7, "saddle");

    public static final int NO_COUNT_LIMIT = 0;
    public static final List<EquipmentSlot> VALUES = List.of(values());
    public static final IntFunction<EquipmentSlot> BY_ID = ByIdMap.<EquipmentSlot>continuous((equipmentslot) -> {
    ...
    public static final StreamCodec<ByteBuf, EquipmentSlot> STREAM_CODEC = ByteBufCodecs.idMapper(EquipmentSlot.BY_ID, (equipmentslot) -> {
        return equipmentslot.id;
    });
    ...
    public static EquipmentSlot byName(String name) {
        EquipmentSlot equipmentslot = EquipmentSlot.CODEC.byName(name);
