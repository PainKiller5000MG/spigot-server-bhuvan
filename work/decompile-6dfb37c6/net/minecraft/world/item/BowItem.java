        ...
        if (!(entity instanceof Player player)) {
            ...
            if (itemstack1.isEmpty()) {
                ...
                if ((double) f < 0.1D) {
                    ...
                    List<ItemStack> list = draw(itemStack, itemstack1, player);
                    ...
                    level.playSound((Entity) null, player.getX(), player.getY(), player.getZ(), SoundEvents.ARROW_SHOOT, SoundSource.PLAYERS, 1.0F, 1.0F / (level.getRandom().nextFloat() * 0.4F + 1.2F) + f * 0.5F);
