        ...
        if (direction == Direction.DOWN) {
            ...
            if (level.noCollision((Entity) null, aabb) && level.getEntities((Entity) null, aabb).isEmpty()) {
                if (level instanceof ServerLevel) {
                    ...
                    Consumer<ArmorStand> consumer = EntityType.<ArmorStand>createDefaultStackConfig(serverlevel, itemstack, context.getPlayer());
                    ...
                    level.playSound((Entity) null, armorstand.getX(), armorstand.getY(), armorstand.getZ(), SoundEvents.ARMOR_STAND_PLACE, SoundSource.BLOCKS, 0.75F, 0.8F);
