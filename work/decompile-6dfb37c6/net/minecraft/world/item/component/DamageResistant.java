...
public record DamageResistant(TagKey<DamageType> types) {
    ...
    public static final Codec<DamageResistant> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(TagKey.hashedCodec(Registries.DAMAGE_TYPE).fieldOf("types").forGetter(DamageResistant::types)).apply(instance, DamageResistant::new);
    });
