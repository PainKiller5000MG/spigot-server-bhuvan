...
public record UseCooldown(float seconds, Optional<Identifier> cooldownGroup) {
    ...
    public static final Codec<UseCooldown> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(ExtraCodecs.POSITIVE_FLOAT.fieldOf("seconds").forGetter(UseCooldown::seconds), Identifier.CODEC.optionalFieldOf("cooldown_group").forGetter(UseCooldown::cooldownGroup)).apply(instance, UseCooldown::new);
    });
