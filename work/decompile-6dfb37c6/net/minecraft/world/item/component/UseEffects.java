...
public record UseEffects(boolean canSprint, boolean interactVibrations, float speedMultiplier) {
    ...
    public static final Codec<UseEffects> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(Codec.BOOL.optionalFieldOf("can_sprint", UseEffects.DEFAULT.canSprint).forGetter(UseEffects::canSprint), Codec.BOOL.optionalFieldOf("interact_vibrations", UseEffects.DEFAULT.interactVibrations).forGetter(UseEffects::interactVibrations), Codec.floatRange(0.0F, 1.0F).optionalFieldOf("speed_multiplier", UseEffects.DEFAULT.speedMultiplier).forGetter(UseEffects::speedMultiplier)).apply(instance, UseEffects::new);
    });
