...
public record SwingAnimation(SwingAnimationType type, int duration) {
    ...
    public static final Codec<SwingAnimation> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(SwingAnimationType.CODEC.optionalFieldOf("type", SwingAnimation.DEFAULT.type).forGetter(SwingAnimation::type), ExtraCodecs.POSITIVE_INT.optionalFieldOf("duration", SwingAnimation.DEFAULT.duration).forGetter(SwingAnimation::duration)).apply(instance, SwingAnimation::new);
    });
