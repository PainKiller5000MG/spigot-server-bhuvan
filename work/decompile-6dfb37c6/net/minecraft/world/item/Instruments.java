...
public interface Instruments {
    ...
    static void bootstrap(BootstrapContext<Instrument> context) {
        register(context, Instruments.PONDER_GOAT_HORN, (Holder) SoundEvents.GOAT_HORN_SOUND_VARIANTS.get(0), 7.0F, 256.0F);
        register(context, Instruments.SING_GOAT_HORN, (Holder) SoundEvents.GOAT_HORN_SOUND_VARIANTS.get(1), 7.0F, 256.0F);
        register(context, Instruments.SEEK_GOAT_HORN, (Holder) SoundEvents.GOAT_HORN_SOUND_VARIANTS.get(2), 7.0F, 256.0F);
        register(context, Instruments.FEEL_GOAT_HORN, (Holder) SoundEvents.GOAT_HORN_SOUND_VARIANTS.get(3), 7.0F, 256.0F);
        register(context, Instruments.ADMIRE_GOAT_HORN, (Holder) SoundEvents.GOAT_HORN_SOUND_VARIANTS.get(4), 7.0F, 256.0F);
        register(context, Instruments.CALL_GOAT_HORN, (Holder) SoundEvents.GOAT_HORN_SOUND_VARIANTS.get(5), 7.0F, 256.0F);
        register(context, Instruments.YEARN_GOAT_HORN, (Holder) SoundEvents.GOAT_HORN_SOUND_VARIANTS.get(6), 7.0F, 256.0F);
        register(context, Instruments.DREAM_GOAT_HORN, (Holder) SoundEvents.GOAT_HORN_SOUND_VARIANTS.get(7), 7.0F, 256.0F);
    }
    ...
    static void register(BootstrapContext<Instrument> context, ResourceKey<Instrument> key, Holder<SoundEvent> soundEvent, float duration, float range) {
        ...
        context.register(key, new Instrument(soundEvent, duration, range, mutablecomponent));
    }
}
