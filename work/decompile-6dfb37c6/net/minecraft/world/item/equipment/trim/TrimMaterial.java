...
public record TrimMaterial(MaterialAssetGroup assets, Component description) {
    ...
    public static final Codec<TrimMaterial> DIRECT_CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(MaterialAssetGroup.MAP_CODEC.forGetter(TrimMaterial::assets), ComponentSerialization.CODEC.fieldOf("description").forGetter(TrimMaterial::description)).apply(instance, TrimMaterial::new);
    });
    ...
    public static final Codec<Holder<TrimMaterial>> CODEC = RegistryFileCodec.<Holder<TrimMaterial>>create(Registries.TRIM_MATERIAL, TrimMaterial.DIRECT_CODEC);
