...
public interface EquipmentAssets {
    ...
    Map<DyeColor, ResourceKey<EquipmentAsset>> CARPETS = Util.<DyeColor, ResourceKey<EquipmentAsset>>makeEnumMap(DyeColor.class, (dyecolor) -> {
        return createId(dyecolor.getSerializedName() + "_carpet");
    });
    ResourceKey<EquipmentAsset> TRADER_LLAMA = createId("trader_llama");
    Map<DyeColor, ResourceKey<EquipmentAsset>> HARNESSES = Util.<DyeColor, ResourceKey<EquipmentAsset>>makeEnumMap(DyeColor.class, (dyecolor) -> {
        return createId(dyecolor.getSerializedName() + "_harness");
    });
