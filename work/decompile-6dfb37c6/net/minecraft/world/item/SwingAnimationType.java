...
public enum SwingAnimationType implements StringRepresentable {
    ...
    NONE(0, "none"), WHACK(1, "whack"), STAB(2, "stab");
    ...
    public static final StreamCodec<ByteBuf, SwingAnimationType> STREAM_CODEC = ByteBufCodecs.idMapper(SwingAnimationType.BY_ID, SwingAnimationType::getId);
