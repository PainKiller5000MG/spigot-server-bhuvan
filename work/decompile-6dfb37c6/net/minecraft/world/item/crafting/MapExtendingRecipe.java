...
public class MapExtendingRecipe extends ShapedRecipe {
    ...
    public MapExtendingRecipe(CraftingBookCategory category) {
        super("", category, ShapedRecipePattern.of(Map.of('#', Ingredient.of((ItemLike) Items.PAPER), 'x', Ingredient.of((ItemLike) Items.FILLED_MAP)), "###", "#x#", "###"), new ItemStack(Items.MAP));
    }
    ...
    public boolean matches(CraftingInput input, Level level) {
        if (!super.matches(input, level)) {
            ...
            if (itemstack.isEmpty()) {
                ...
                return mapitemsaveddata == null ? false : (mapitemsaveddata.isExplorationMap() ? false : mapitemsaveddata.scale < 4);
            }
        }
    }
