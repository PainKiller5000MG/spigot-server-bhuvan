...
public record StonecutterRecipeDisplay(SlotDisplay input, SlotDisplay result, SlotDisplay craftingStation) implements RecipeDisplay {
    ...
    public static final RecipeDisplay.Type<StonecutterRecipeDisplay> TYPE = new RecipeDisplay.Type<StonecutterRecipeDisplay>(StonecutterRecipeDisplay.MAP_CODEC, StonecutterRecipeDisplay.STREAM_CODEC);
