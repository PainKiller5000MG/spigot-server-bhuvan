...
public record ShapelessCraftingRecipeDisplay(List<SlotDisplay> ingredients, SlotDisplay result, SlotDisplay craftingStation) implements RecipeDisplay {
    ...
    public static final RecipeDisplay.Type<ShapelessCraftingRecipeDisplay> TYPE = new RecipeDisplay.Type<ShapelessCraftingRecipeDisplay>(ShapelessCraftingRecipeDisplay.MAP_CODEC, ShapelessCraftingRecipeDisplay.STREAM_CODEC);
