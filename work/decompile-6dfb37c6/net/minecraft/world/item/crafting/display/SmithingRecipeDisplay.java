...
public record SmithingRecipeDisplay(SlotDisplay template, SlotDisplay base, SlotDisplay addition, SlotDisplay result, SlotDisplay craftingStation) implements RecipeDisplay {
    ...
    public static final MapCodec<SmithingRecipeDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec((instance) -> {
    ...
    public static final RecipeDisplay.Type<SmithingRecipeDisplay> TYPE = new RecipeDisplay.Type<SmithingRecipeDisplay>(SmithingRecipeDisplay.MAP_CODEC, SmithingRecipeDisplay.STREAM_CODEC);

    @Override
    public RecipeDisplay.Type<SmithingRecipeDisplay> type() {
        return SmithingRecipeDisplay.TYPE;
    }
}
