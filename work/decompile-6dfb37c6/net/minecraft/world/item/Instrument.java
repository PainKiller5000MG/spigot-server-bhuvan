...
public record Instrument(Holder<SoundEvent> soundEvent, float useDuration, float range, Component description) {
    ...
    public static final Codec<Instrument> DIRECT_CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(SoundEvent.CODEC.fieldOf("sound_event").forGetter(Instrument::soundEvent), ExtraCodecs.POSITIVE_FLOAT.fieldOf("use_duration").forGetter(Instrument::useDuration), ExtraCodecs.POSITIVE_FLOAT.fieldOf("range").forGetter(Instrument::range), ComponentSerialization.CODEC.fieldOf("description").forGetter(Instrument::description)).apply(instance, Instrument::new);
    });
    ...
    public static final Codec<Holder<Instrument>> CODEC = RegistryFileCodec.<Holder<Instrument>>create(Registries.INSTRUMENT, Instrument.DIRECT_CODEC);
