...
public record ApplyEntityImpulse(Vec3 direction, Vec3 coordinateScale, LevelBasedValue magnitude) implements EnchantmentEntityEffect {
    ...
    public void apply(ServerLevel serverLevel, int enchantmentLevel, EnchantedItemInUse item, Entity entity, Vec3 position) {
        ...
        Vec3 vec32 = vec31.addLocalCoordinates(this.direction).multiply(this.coordinateScale).scale((double) this.magnitude.calculate(enchantmentLevel));

        entity.addDeltaMovement(vec32);
    ...
    public MapCodec<ApplyEntityImpulse> codec() {
        return ApplyEntityImpulse.CODEC;
    }
}
