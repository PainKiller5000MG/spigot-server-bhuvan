...
public record MultiplyValue(LevelBasedValue factor) implements EnchantmentValueEffect {
    ...
    public static final MapCodec<MultiplyValue> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(LevelBasedValue.CODEC.fieldOf("factor").forGetter(MultiplyValue::factor)).apply(instance, MultiplyValue::new);
    });
