...
public record AddValue(LevelBasedValue value) implements EnchantmentValueEffect {
    ...
    public static final MapCodec<AddValue> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(LevelBasedValue.CODEC.fieldOf("value").forGetter(AddValue::value)).apply(instance, AddValue::new);
    });
