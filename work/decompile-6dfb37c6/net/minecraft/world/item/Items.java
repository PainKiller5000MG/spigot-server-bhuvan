...
public class Items {
    ...
    public static final Item BUSH = registerBlock(Blocks.BUSH);
    ...
    public static final Item WILDFLOWERS = registerBlock(Blocks.WILDFLOWERS);
    public static final Item LEAF_LITTER = registerBlock(Blocks.LEAF_LITTER);
    ...
    public static final Item ACACIA_SHELF = registerBlock(Blocks.ACACIA_SHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item BAMBOO_SHELF = registerBlock(Blocks.BAMBOO_SHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item BIRCH_SHELF = registerBlock(Blocks.BIRCH_SHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item CHERRY_SHELF = registerBlock(Blocks.CHERRY_SHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item CRIMSON_SHELF = registerBlock(Blocks.CRIMSON_SHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item DARK_OAK_SHELF = registerBlock(Blocks.DARK_OAK_SHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item JUNGLE_SHELF = registerBlock(Blocks.JUNGLE_SHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item MANGROVE_SHELF = registerBlock(Blocks.MANGROVE_SHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item OAK_SHELF = registerBlock(Blocks.OAK_SHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item PALE_OAK_SHELF = registerBlock(Blocks.PALE_OAK_SHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item SPRUCE_SHELF = registerBlock(Blocks.SPRUCE_SHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item WARPED_SHELF = registerBlock(Blocks.WARPED_SHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item BOOKSHELF = registerBlock(Blocks.BOOKSHELF);
    public static final Item CHISELED_BOOKSHELF = registerBlock(Blocks.CHISELED_BOOKSHELF, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item DECORATED_POT = registerBlock(Blocks.DECORATED_POT, (new Item.Properties()).component(DataComponents.POT_DECORATIONS, PotDecorations.EMPTY).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item TORCH = registerBlock(Blocks.TORCH, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.WALL_TORCH, Direction.DOWN, item_properties);
    });
    ...
    public static final Item CHEST = registerBlock(Blocks.CHEST, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item CRAFTING_TABLE = registerBlock(Blocks.CRAFTING_TABLE);
    public static final Item FARMLAND = registerBlock(Blocks.FARMLAND);
    public static final Item FURNACE = registerBlock(Blocks.FURNACE, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    ...
    public static final Item CACTUS_FLOWER = registerBlock(Blocks.CACTUS_FLOWER);
    ...
    public static final Item CARVED_PUMPKIN = registerBlock(Blocks.CARVED_PUMPKIN, (item_properties) -> {
        return Waypoint.addHideAttribute(item_properties).component(DataComponents.EQUIPPABLE, Equippable.builder(EquipmentSlot.HEAD).setSwappable(false).setCameraOverlay(Identifier.withDefaultNamespace("misc/pumpkinblur")).build());
    });
    ...
    public static final Item SOUL_TORCH = registerBlock(Blocks.SOUL_TORCH, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.SOUL_WALL_TORCH, Direction.DOWN, item_properties);
    });
    public static final Item COPPER_TORCH = registerBlock(Blocks.COPPER_TORCH, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.COPPER_WALL_TORCH, Direction.DOWN, item_properties);
    });
    ...
    public static final Item IRON_CHAIN = registerBlock(Blocks.IRON_CHAIN);
    public static final WeatheringCopperItems COPPER_CHAIN = WeatheringCopperItems.create(Blocks.COPPER_CHAIN, Items::registerBlock);
    ...
    public static final Item LIGHT = registerBlock(Blocks.LIGHT, (item_properties) -> {
        return item_properties.rarity(Rarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(LightBlock.LEVEL, 15));
    });
    public static final Item HAY_BLOCK = registerBlock(Blocks.HAY_BLOCK);
    public static final Item WHITE_CARPET = registerBlock(Blocks.WHITE_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.WHITE));
    });
    public static final Item ORANGE_CARPET = registerBlock(Blocks.ORANGE_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.ORANGE));
    });
    public static final Item MAGENTA_CARPET = registerBlock(Blocks.MAGENTA_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.MAGENTA));
    });
    public static final Item LIGHT_BLUE_CARPET = registerBlock(Blocks.LIGHT_BLUE_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_BLUE));
    });
    public static final Item YELLOW_CARPET = registerBlock(Blocks.YELLOW_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.YELLOW));
    });
    public static final Item LIME_CARPET = registerBlock(Blocks.LIME_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIME));
    });
    public static final Item PINK_CARPET = registerBlock(Blocks.PINK_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PINK));
    });
    public static final Item GRAY_CARPET = registerBlock(Blocks.GRAY_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GRAY));
    });
    public static final Item LIGHT_GRAY_CARPET = registerBlock(Blocks.LIGHT_GRAY_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_GRAY));
    });
    public static final Item CYAN_CARPET = registerBlock(Blocks.CYAN_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.CYAN));
    });
    public static final Item PURPLE_CARPET = registerBlock(Blocks.PURPLE_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PURPLE));
    });
    public static final Item BLUE_CARPET = registerBlock(Blocks.BLUE_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLUE));
    });
    public static final Item BROWN_CARPET = registerBlock(Blocks.BROWN_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BROWN));
    });
    public static final Item GREEN_CARPET = registerBlock(Blocks.GREEN_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GREEN));
    });
    public static final Item RED_CARPET = registerBlock(Blocks.RED_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.RED));
    });
    public static final Item BLACK_CARPET = registerBlock(Blocks.BLACK_CARPET, (item_properties) -> {
        return item_properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLACK));
    });
    ...
    public static final Item SHULKER_BOX = registerBlock(Blocks.SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item WHITE_SHULKER_BOX = registerBlock(Blocks.WHITE_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item ORANGE_SHULKER_BOX = registerBlock(Blocks.ORANGE_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item MAGENTA_SHULKER_BOX = registerBlock(Blocks.MAGENTA_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item LIGHT_BLUE_SHULKER_BOX = registerBlock(Blocks.LIGHT_BLUE_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item YELLOW_SHULKER_BOX = registerBlock(Blocks.YELLOW_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item LIME_SHULKER_BOX = registerBlock(Blocks.LIME_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item PINK_SHULKER_BOX = registerBlock(Blocks.PINK_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item GRAY_SHULKER_BOX = registerBlock(Blocks.GRAY_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item LIGHT_GRAY_SHULKER_BOX = registerBlock(Blocks.LIGHT_GRAY_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item CYAN_SHULKER_BOX = registerBlock(Blocks.CYAN_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item PURPLE_SHULKER_BOX = registerBlock(Blocks.PURPLE_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BLUE_SHULKER_BOX = registerBlock(Blocks.BLUE_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BROWN_SHULKER_BOX = registerBlock(Blocks.BROWN_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item GREEN_SHULKER_BOX = registerBlock(Blocks.GREEN_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item RED_SHULKER_BOX = registerBlock(Blocks.RED_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BLACK_SHULKER_BOX = registerBlock(Blocks.BLACK_SHULKER_BOX, (new Item.Properties()).stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item SNIFFER_EGG = registerBlock(Blocks.SNIFFER_EGG, (item_properties) -> {
        return item_properties.rarity(Rarity.UNCOMMON);
    });
    ...
    public static final Item TUBE_CORAL_FAN = registerBlock(Blocks.TUBE_CORAL_FAN, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.TUBE_CORAL_WALL_FAN, Direction.DOWN, item_properties);
    });
    public static final Item BRAIN_CORAL_FAN = registerBlock(Blocks.BRAIN_CORAL_FAN, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.BRAIN_CORAL_WALL_FAN, Direction.DOWN, item_properties);
    });
    public static final Item BUBBLE_CORAL_FAN = registerBlock(Blocks.BUBBLE_CORAL_FAN, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.BUBBLE_CORAL_WALL_FAN, Direction.DOWN, item_properties);
    });
    public static final Item FIRE_CORAL_FAN = registerBlock(Blocks.FIRE_CORAL_FAN, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.FIRE_CORAL_WALL_FAN, Direction.DOWN, item_properties);
    });
    public static final Item HORN_CORAL_FAN = registerBlock(Blocks.HORN_CORAL_FAN, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.HORN_CORAL_WALL_FAN, Direction.DOWN, item_properties);
    });
    public static final Item DEAD_TUBE_CORAL_FAN = registerBlock(Blocks.DEAD_TUBE_CORAL_FAN, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.DEAD_TUBE_CORAL_WALL_FAN, Direction.DOWN, item_properties);
    });
    public static final Item DEAD_BRAIN_CORAL_FAN = registerBlock(Blocks.DEAD_BRAIN_CORAL_FAN, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.DEAD_BRAIN_CORAL_WALL_FAN, Direction.DOWN, item_properties);
    });
    public static final Item DEAD_BUBBLE_CORAL_FAN = registerBlock(Blocks.DEAD_BUBBLE_CORAL_FAN, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, Direction.DOWN, item_properties);
    });
    public static final Item DEAD_FIRE_CORAL_FAN = registerBlock(Blocks.DEAD_FIRE_CORAL_FAN, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.DEAD_FIRE_CORAL_WALL_FAN, Direction.DOWN, item_properties);
    });
    public static final Item DEAD_HORN_CORAL_FAN = registerBlock(Blocks.DEAD_HORN_CORAL_FAN, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.DEAD_HORN_CORAL_WALL_FAN, Direction.DOWN, item_properties);
    });
    ...
    public static final Item REDSTONE = registerItem("redstone", createBlockItemWithCustomItemName(Blocks.REDSTONE_WIRE), (new Item.Properties()).trimMaterial(TrimMaterials.REDSTONE));
    public static final Item REDSTONE_TORCH = registerBlock(Blocks.REDSTONE_TORCH, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.REDSTONE_WALL_TORCH, Direction.DOWN, item_properties);
    });
    ...
    public static final Item HOPPER = registerBlock(Blocks.HOPPER, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item DISPENSER = registerBlock(Blocks.DISPENSER, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item DROPPER = registerBlock(Blocks.DROPPER, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    ...
    public static final Item EXPOSED_LIGHTNING_ROD = registerBlock(Blocks.EXPOSED_LIGHTNING_ROD);
    public static final Item WEATHERED_LIGHTNING_ROD = registerBlock(Blocks.WEATHERED_LIGHTNING_ROD);
    public static final Item OXIDIZED_LIGHTNING_ROD = registerBlock(Blocks.OXIDIZED_LIGHTNING_ROD);
    public static final Item WAXED_LIGHTNING_ROD = registerBlock(Blocks.WAXED_LIGHTNING_ROD);
    public static final Item WAXED_EXPOSED_LIGHTNING_ROD = registerBlock(Blocks.WAXED_EXPOSED_LIGHTNING_ROD);
    public static final Item WAXED_WEATHERED_LIGHTNING_ROD = registerBlock(Blocks.WAXED_WEATHERED_LIGHTNING_ROD);
    public static final Item WAXED_OXIDIZED_LIGHTNING_ROD = registerBlock(Blocks.WAXED_OXIDIZED_LIGHTNING_ROD);
    ...
    public static final Item TRAPPED_CHEST = registerBlock(Blocks.TRAPPED_CHEST, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    ...
    public static final Item WHITE_HARNESS = registerItem("white_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.WHITE)));
    public static final Item ORANGE_HARNESS = registerItem("orange_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.ORANGE)));
    public static final Item MAGENTA_HARNESS = registerItem("magenta_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.MAGENTA)));
    public static final Item LIGHT_BLUE_HARNESS = registerItem("light_blue_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.LIGHT_BLUE)));
    public static final Item YELLOW_HARNESS = registerItem("yellow_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.YELLOW)));
    public static final Item LIME_HARNESS = registerItem("lime_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.LIME)));
    public static final Item PINK_HARNESS = registerItem("pink_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.PINK)));
    public static final Item GRAY_HARNESS = registerItem("gray_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.GRAY)));
    public static final Item LIGHT_GRAY_HARNESS = registerItem("light_gray_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.LIGHT_GRAY)));
    public static final Item CYAN_HARNESS = registerItem("cyan_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.CYAN)));
    public static final Item PURPLE_HARNESS = registerItem("purple_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.PURPLE)));
    public static final Item BLUE_HARNESS = registerItem("blue_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.BLUE)));
    public static final Item BROWN_HARNESS = registerItem("brown_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.BROWN)));
    public static final Item GREEN_HARNESS = registerItem("green_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.GREEN)));
    public static final Item RED_HARNESS = registerItem("red_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.RED)));
    public static final Item BLACK_HARNESS = registerItem("black_harness", (new Item.Properties()).stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.BLACK)));
    public static final Item MINECART = registerItem("minecart", (item_properties) -> {
        return new MinecartItem(EntityType.MINECART, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item CHEST_MINECART = registerItem("chest_minecart", (item_properties) -> {
        return new MinecartItem(EntityType.CHEST_MINECART, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item FURNACE_MINECART = registerItem("furnace_minecart", (item_properties) -> {
        return new MinecartItem(EntityType.FURNACE_MINECART, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item TNT_MINECART = registerItem("tnt_minecart", (item_properties) -> {
        return new MinecartItem(EntityType.TNT_MINECART, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item HOPPER_MINECART = registerItem("hopper_minecart", (item_properties) -> {
        return new MinecartItem(EntityType.HOPPER_MINECART, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item CARROT_ON_A_STICK = registerItem("carrot_on_a_stick", (item_properties) -> {
        return new FoodOnAStickItem(EntityType.PIG, 7, item_properties);
    }, (new Item.Properties()).durability(25));
    public static final Item WARPED_FUNGUS_ON_A_STICK = registerItem("warped_fungus_on_a_stick", (item_properties) -> {
        return new FoodOnAStickItem(EntityType.STRIDER, 1, item_properties);
    }, (new Item.Properties()).durability(100));
    public static final Item PHANTOM_MEMBRANE = registerItem("phantom_membrane");
    public static final Item ELYTRA = registerItem("elytra", (new Item.Properties()).durability(432).rarity(Rarity.EPIC).component(DataComponents.GLIDER, Unit.INSTANCE).component(DataComponents.EQUIPPABLE, Equippable.builder(EquipmentSlot.CHEST).setEquipSound(SoundEvents.ARMOR_EQUIP_ELYTRA).setAsset(EquipmentAssets.ELYTRA).setDamageOnHurt(false).build()).repairable(Items.PHANTOM_MEMBRANE));
    public static final Item OAK_BOAT = registerItem("oak_boat", (item_properties) -> {
        return new BoatItem(EntityType.OAK_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item OAK_CHEST_BOAT = registerItem("oak_chest_boat", (item_properties) -> {
        return new BoatItem(EntityType.OAK_CHEST_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item SPRUCE_BOAT = registerItem("spruce_boat", (item_properties) -> {
        return new BoatItem(EntityType.SPRUCE_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item SPRUCE_CHEST_BOAT = registerItem("spruce_chest_boat", (item_properties) -> {
        return new BoatItem(EntityType.SPRUCE_CHEST_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item BIRCH_BOAT = registerItem("birch_boat", (item_properties) -> {
        return new BoatItem(EntityType.BIRCH_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item BIRCH_CHEST_BOAT = registerItem("birch_chest_boat", (item_properties) -> {
        return new BoatItem(EntityType.BIRCH_CHEST_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item JUNGLE_BOAT = registerItem("jungle_boat", (item_properties) -> {
        return new BoatItem(EntityType.JUNGLE_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item JUNGLE_CHEST_BOAT = registerItem("jungle_chest_boat", (item_properties) -> {
        return new BoatItem(EntityType.JUNGLE_CHEST_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item ACACIA_BOAT = registerItem("acacia_boat", (item_properties) -> {
        return new BoatItem(EntityType.ACACIA_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item ACACIA_CHEST_BOAT = registerItem("acacia_chest_boat", (item_properties) -> {
        return new BoatItem(EntityType.ACACIA_CHEST_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item CHERRY_BOAT = registerItem("cherry_boat", (item_properties) -> {
        return new BoatItem(EntityType.CHERRY_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item CHERRY_CHEST_BOAT = registerItem("cherry_chest_boat", (item_properties) -> {
        return new BoatItem(EntityType.CHERRY_CHEST_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item DARK_OAK_BOAT = registerItem("dark_oak_boat", (item_properties) -> {
        return new BoatItem(EntityType.DARK_OAK_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item DARK_OAK_CHEST_BOAT = registerItem("dark_oak_chest_boat", (item_properties) -> {
        return new BoatItem(EntityType.DARK_OAK_CHEST_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item PALE_OAK_BOAT = registerItem("pale_oak_boat", (item_properties) -> {
        return new BoatItem(EntityType.PALE_OAK_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item PALE_OAK_CHEST_BOAT = registerItem("pale_oak_chest_boat", (item_properties) -> {
        return new BoatItem(EntityType.PALE_OAK_CHEST_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item MANGROVE_BOAT = registerItem("mangrove_boat", (item_properties) -> {
        return new BoatItem(EntityType.MANGROVE_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item MANGROVE_CHEST_BOAT = registerItem("mangrove_chest_boat", (item_properties) -> {
        return new BoatItem(EntityType.MANGROVE_CHEST_BOAT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item BAMBOO_RAFT = registerItem("bamboo_raft", (item_properties) -> {
        return new BoatItem(EntityType.BAMBOO_RAFT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    public static final Item BAMBOO_CHEST_RAFT = registerItem("bamboo_chest_raft", (item_properties) -> {
        return new BoatItem(EntityType.BAMBOO_CHEST_RAFT, item_properties);
    }, (new Item.Properties()).stacksTo(1));
    ...
    public static final Item TEST_BLOCK = registerBlock(Blocks.TEST_BLOCK, GameMasterBlockItem::new, (new Item.Properties()).rarity(Rarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(TestBlock.MODE, TestBlockMode.START)));
    public static final Item TEST_INSTANCE_BLOCK = registerBlock(Blocks.TEST_INSTANCE_BLOCK, GameMasterBlockItem::new, (new Item.Properties()).rarity(Rarity.EPIC));
    ...
    public static final Item DIAMOND = registerItem("diamond", (new Item.Properties()).trimMaterial(TrimMaterials.DIAMOND));
    public static final Item EMERALD = registerItem("emerald", (new Item.Properties()).trimMaterial(TrimMaterials.EMERALD));
    public static final Item LAPIS_LAZULI = registerItem("lapis_lazuli", (new Item.Properties()).trimMaterial(TrimMaterials.LAPIS));
    public static final Item QUARTZ = registerItem("quartz", (new Item.Properties()).trimMaterial(TrimMaterials.QUARTZ));
    public static final Item AMETHYST_SHARD = registerItem("amethyst_shard", (new Item.Properties()).trimMaterial(TrimMaterials.AMETHYST));
    public static final Item RAW_IRON = registerItem("raw_iron");
    public static final Item IRON_INGOT = registerItem("iron_ingot", (new Item.Properties()).trimMaterial(TrimMaterials.IRON));
    public static final Item RAW_COPPER = registerItem("raw_copper");
    public static final Item COPPER_INGOT = registerItem("copper_ingot", (new Item.Properties()).trimMaterial(TrimMaterials.COPPER));
    ...
    public static final Item WOODEN_SHOVEL = registerItem("wooden_shovel", (item_properties) -> {
        return new ShovelItem(ToolMaterial.WOOD, 1.5F, -3.0F, item_properties);
    });
    ...
    public static final Item WOODEN_AXE = registerItem("wooden_axe", (item_properties) -> {
        return new AxeItem(ToolMaterial.WOOD, 6.0F, -3.2F, item_properties);
    });
    public static final Item WOODEN_HOE = registerItem("wooden_hoe", (item_properties) -> {
        return new HoeItem(ToolMaterial.WOOD, 0.0F, -3.0F, item_properties);
    });
    public static final Item COPPER_SWORD = registerItem("copper_sword", (new Item.Properties()).sword(ToolMaterial.COPPER, 3.0F, -2.4F));
    public static final Item COPPER_SHOVEL = registerItem("copper_shovel", (item_properties) -> {
        return new ShovelItem(ToolMaterial.COPPER, 1.5F, -3.0F, item_properties);
    });
    ...
    public static final Item COPPER_AXE = registerItem("copper_axe", (item_properties) -> {
        return new AxeItem(ToolMaterial.COPPER, 7.0F, -3.2F, item_properties);
    });
    public static final Item COPPER_HOE = registerItem("copper_hoe", (item_properties) -> {
        return new HoeItem(ToolMaterial.COPPER, -1.0F, -2.0F, item_properties);
    });
    public static final Item STONE_SWORD = registerItem("stone_sword", (new Item.Properties()).sword(ToolMaterial.STONE, 3.0F, -2.4F));
    public static final Item STONE_SHOVEL = registerItem("stone_shovel", (item_properties) -> {
        return new ShovelItem(ToolMaterial.STONE, 1.5F, -3.0F, item_properties);
    });
    ...
    public static final Item STONE_AXE = registerItem("stone_axe", (item_properties) -> {
        return new AxeItem(ToolMaterial.STONE, 7.0F, -3.2F, item_properties);
    });
    public static final Item STONE_HOE = registerItem("stone_hoe", (item_properties) -> {
        return new HoeItem(ToolMaterial.STONE, -1.0F, -2.0F, item_properties);
    });
    public static final Item GOLDEN_SWORD = registerItem("golden_sword", (new Item.Properties()).sword(ToolMaterial.GOLD, 3.0F, -2.4F));
    public static final Item GOLDEN_SHOVEL = registerItem("golden_shovel", (item_properties) -> {
        return new ShovelItem(ToolMaterial.GOLD, 1.5F, -3.0F, item_properties);
    });
    ...
    public static final Item GOLDEN_AXE = registerItem("golden_axe", (item_properties) -> {
        return new AxeItem(ToolMaterial.GOLD, 6.0F, -3.0F, item_properties);
    });
    public static final Item GOLDEN_HOE = registerItem("golden_hoe", (item_properties) -> {
        return new HoeItem(ToolMaterial.GOLD, 0.0F, -3.0F, item_properties);
    });
    public static final Item IRON_SWORD = registerItem("iron_sword", (new Item.Properties()).sword(ToolMaterial.IRON, 3.0F, -2.4F));
    public static final Item IRON_SHOVEL = registerItem("iron_shovel", (item_properties) -> {
        return new ShovelItem(ToolMaterial.IRON, 1.5F, -3.0F, item_properties);
    });
    public static final Item IRON_PICKAXE = registerItem("iron_pickaxe", (new Item.Properties()).pickaxe(ToolMaterial.IRON, 1.0F, -2.8F));
    public static final Item IRON_AXE = registerItem("iron_axe", (item_properties) -> {
        return new AxeItem(ToolMaterial.IRON, 6.0F, -3.1F, item_properties);
    });
    public static final Item IRON_HOE = registerItem("iron_hoe", (item_properties) -> {
        return new HoeItem(ToolMaterial.IRON, -2.0F, -1.0F, item_properties);
    });
    ...
    public static final Item DIAMOND_SHOVEL = registerItem("diamond_shovel", (item_properties) -> {
        return new ShovelItem(ToolMaterial.DIAMOND, 1.5F, -3.0F, item_properties);
    });
    ...
    public static final Item DIAMOND_AXE = registerItem("diamond_axe", (item_properties) -> {
        return new AxeItem(ToolMaterial.DIAMOND, 5.0F, -3.0F, item_properties);
    });
    public static final Item DIAMOND_HOE = registerItem("diamond_hoe", (item_properties) -> {
        return new HoeItem(ToolMaterial.DIAMOND, -3.0F, 0.0F, item_properties);
    });
    ...
    public static final Item NETHERITE_SHOVEL = registerItem("netherite_shovel", (item_properties) -> {
        return new ShovelItem(ToolMaterial.NETHERITE, 1.5F, -3.0F, item_properties);
    }, (new Item.Properties()).fireResistant());
    public static final Item NETHERITE_PICKAXE = registerItem("netherite_pickaxe", (new Item.Properties()).pickaxe(ToolMaterial.NETHERITE, 1.0F, -2.8F).fireResistant());
    public static final Item NETHERITE_AXE = registerItem("netherite_axe", (item_properties) -> {
        return new AxeItem(ToolMaterial.NETHERITE, 5.0F, -3.0F, item_properties);
    }, (new Item.Properties()).fireResistant());
    public static final Item NETHERITE_HOE = registerItem("netherite_hoe", (item_properties) -> {
        return new HoeItem(ToolMaterial.NETHERITE, -4.0F, 0.0F, item_properties);
    }, (new Item.Properties()).fireResistant());
    public static final Item STICK = registerItem("stick");
    public static final Item MUSHROOM_STEW = registerItem("mushroom_stew", (new Item.Properties()).stacksTo(1).food(Foods.MUSHROOM_STEW).usingConvertsTo(Items.BOWL));
    ...
    public static final Item LEATHER_HELMET = registerItem("leather_helmet", (new Item.Properties()).humanoidArmor(ArmorMaterials.LEATHER, ArmorType.HELMET));
    public static final Item LEATHER_CHESTPLATE = registerItem("leather_chestplate", (new Item.Properties()).humanoidArmor(ArmorMaterials.LEATHER, ArmorType.CHESTPLATE));
    public static final Item LEATHER_LEGGINGS = registerItem("leather_leggings", (new Item.Properties()).humanoidArmor(ArmorMaterials.LEATHER, ArmorType.LEGGINGS));
    public static final Item LEATHER_BOOTS = registerItem("leather_boots", (new Item.Properties()).humanoidArmor(ArmorMaterials.LEATHER, ArmorType.BOOTS));
    public static final Item COPPER_HELMET = registerItem("copper_helmet", (new Item.Properties()).humanoidArmor(ArmorMaterials.COPPER, ArmorType.HELMET));
    public static final Item COPPER_CHESTPLATE = registerItem("copper_chestplate", (new Item.Properties()).humanoidArmor(ArmorMaterials.COPPER, ArmorType.CHESTPLATE));
    public static final Item COPPER_LEGGINGS = registerItem("copper_leggings", (new Item.Properties()).humanoidArmor(ArmorMaterials.COPPER, ArmorType.LEGGINGS));
    public static final Item COPPER_BOOTS = registerItem("copper_boots", (new Item.Properties()).humanoidArmor(ArmorMaterials.COPPER, ArmorType.BOOTS));
    public static final Item CHAINMAIL_HELMET = registerItem("chainmail_helmet", (new Item.Properties()).humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.HELMET).rarity(Rarity.UNCOMMON));
    public static final Item CHAINMAIL_CHESTPLATE = registerItem("chainmail_chestplate", (new Item.Properties()).humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.CHESTPLATE).rarity(Rarity.UNCOMMON));
    public static final Item CHAINMAIL_LEGGINGS = registerItem("chainmail_leggings", (new Item.Properties()).humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.LEGGINGS).rarity(Rarity.UNCOMMON));
    public static final Item CHAINMAIL_BOOTS = registerItem("chainmail_boots", (new Item.Properties()).humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.BOOTS).rarity(Rarity.UNCOMMON));
    public static final Item IRON_HELMET = registerItem("iron_helmet", (new Item.Properties()).humanoidArmor(ArmorMaterials.IRON, ArmorType.HELMET));
    public static final Item IRON_CHESTPLATE = registerItem("iron_chestplate", (new Item.Properties()).humanoidArmor(ArmorMaterials.IRON, ArmorType.CHESTPLATE));
    public static final Item IRON_LEGGINGS = registerItem("iron_leggings", (new Item.Properties()).humanoidArmor(ArmorMaterials.IRON, ArmorType.LEGGINGS));
    public static final Item IRON_BOOTS = registerItem("iron_boots", (new Item.Properties()).humanoidArmor(ArmorMaterials.IRON, ArmorType.BOOTS));
    ...
    public static final Item DIAMOND_CHESTPLATE = registerItem("diamond_chestplate", (new Item.Properties()).humanoidArmor(ArmorMaterials.DIAMOND, ArmorType.CHESTPLATE));
    ...
    public static final Item GOLDEN_HELMET = registerItem("golden_helmet", (new Item.Properties()).humanoidArmor(ArmorMaterials.GOLD, ArmorType.HELMET));
    public static final Item GOLDEN_CHESTPLATE = registerItem("golden_chestplate", (new Item.Properties()).humanoidArmor(ArmorMaterials.GOLD, ArmorType.CHESTPLATE));
    public static final Item GOLDEN_LEGGINGS = registerItem("golden_leggings", (new Item.Properties()).humanoidArmor(ArmorMaterials.GOLD, ArmorType.LEGGINGS));
    public static final Item GOLDEN_BOOTS = registerItem("golden_boots", (new Item.Properties()).humanoidArmor(ArmorMaterials.GOLD, ArmorType.BOOTS));
    public static final Item NETHERITE_HELMET = registerItem("netherite_helmet", (new Item.Properties()).humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.HELMET).fireResistant());
    public static final Item NETHERITE_CHESTPLATE = registerItem("netherite_chestplate", (new Item.Properties()).humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.CHESTPLATE).fireResistant());
    public static final Item NETHERITE_LEGGINGS = registerItem("netherite_leggings", (new Item.Properties()).humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.LEGGINGS).fireResistant());
    ...
    public static final Item PAINTING = registerItem("painting", (item_properties) -> {
        return new HangingEntityItem(EntityType.PAINTING, item_properties);
    });
    ...
    public static final Item ENCHANTED_GOLDEN_APPLE = registerItem("enchanted_golden_apple", (new Item.Properties()).rarity(Rarity.RARE).food(Foods.ENCHANTED_GOLDEN_APPLE, Consumables.ENCHANTED_GOLDEN_APPLE).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true));
    public static final Item OAK_SIGN = registerBlock(Blocks.OAK_SIGN, (block, item_properties) -> {
        return new SignItem(block, Blocks.OAK_WALL_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item SPRUCE_SIGN = registerBlock(Blocks.SPRUCE_SIGN, (block, item_properties) -> {
        return new SignItem(block, Blocks.SPRUCE_WALL_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item BIRCH_SIGN = registerBlock(Blocks.BIRCH_SIGN, (block, item_properties) -> {
        return new SignItem(block, Blocks.BIRCH_WALL_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item JUNGLE_SIGN = registerBlock(Blocks.JUNGLE_SIGN, (block, item_properties) -> {
        return new SignItem(block, Blocks.JUNGLE_WALL_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item ACACIA_SIGN = registerBlock(Blocks.ACACIA_SIGN, (block, item_properties) -> {
        return new SignItem(block, Blocks.ACACIA_WALL_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item CHERRY_SIGN = registerBlock(Blocks.CHERRY_SIGN, (block, item_properties) -> {
        return new SignItem(block, Blocks.CHERRY_WALL_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item DARK_OAK_SIGN = registerBlock(Blocks.DARK_OAK_SIGN, (block, item_properties) -> {
        return new SignItem(block, Blocks.DARK_OAK_WALL_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item PALE_OAK_SIGN = registerBlock(Blocks.PALE_OAK_SIGN, (block, item_properties) -> {
        return new SignItem(block, Blocks.PALE_OAK_WALL_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item MANGROVE_SIGN = registerBlock(Blocks.MANGROVE_SIGN, (block, item_properties) -> {
        return new SignItem(block, Blocks.MANGROVE_WALL_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item BAMBOO_SIGN = registerBlock(Blocks.BAMBOO_SIGN, (block, item_properties) -> {
        return new SignItem(block, Blocks.BAMBOO_WALL_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item CRIMSON_SIGN = registerBlock(Blocks.CRIMSON_SIGN, (block, item_properties) -> {
        return new SignItem(block, Blocks.CRIMSON_WALL_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item WARPED_SIGN = registerBlock(Blocks.WARPED_SIGN, (block, item_properties) -> {
        return new SignItem(block, Blocks.WARPED_WALL_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item OAK_HANGING_SIGN = registerBlock(Blocks.OAK_HANGING_SIGN, (block, item_properties) -> {
        return new HangingSignItem(block, Blocks.OAK_WALL_HANGING_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item SPRUCE_HANGING_SIGN = registerBlock(Blocks.SPRUCE_HANGING_SIGN, (block, item_properties) -> {
        return new HangingSignItem(block, Blocks.SPRUCE_WALL_HANGING_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item BIRCH_HANGING_SIGN = registerBlock(Blocks.BIRCH_HANGING_SIGN, (block, item_properties) -> {
        return new HangingSignItem(block, Blocks.BIRCH_WALL_HANGING_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item JUNGLE_HANGING_SIGN = registerBlock(Blocks.JUNGLE_HANGING_SIGN, (block, item_properties) -> {
        return new HangingSignItem(block, Blocks.JUNGLE_WALL_HANGING_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item ACACIA_HANGING_SIGN = registerBlock(Blocks.ACACIA_HANGING_SIGN, (block, item_properties) -> {
        return new HangingSignItem(block, Blocks.ACACIA_WALL_HANGING_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item CHERRY_HANGING_SIGN = registerBlock(Blocks.CHERRY_HANGING_SIGN, (block, item_properties) -> {
        return new HangingSignItem(block, Blocks.CHERRY_WALL_HANGING_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item DARK_OAK_HANGING_SIGN = registerBlock(Blocks.DARK_OAK_HANGING_SIGN, (block, item_properties) -> {
        return new HangingSignItem(block, Blocks.DARK_OAK_WALL_HANGING_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item PALE_OAK_HANGING_SIGN = registerBlock(Blocks.PALE_OAK_HANGING_SIGN, (block, item_properties) -> {
        return new HangingSignItem(block, Blocks.PALE_OAK_WALL_HANGING_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item MANGROVE_HANGING_SIGN = registerBlock(Blocks.MANGROVE_HANGING_SIGN, (block, item_properties) -> {
        return new HangingSignItem(block, Blocks.MANGROVE_WALL_HANGING_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item BAMBOO_HANGING_SIGN = registerBlock(Blocks.BAMBOO_HANGING_SIGN, (block, item_properties) -> {
        return new HangingSignItem(block, Blocks.BAMBOO_WALL_HANGING_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item CRIMSON_HANGING_SIGN = registerBlock(Blocks.CRIMSON_HANGING_SIGN, (block, item_properties) -> {
        return new HangingSignItem(block, Blocks.CRIMSON_WALL_HANGING_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item WARPED_HANGING_SIGN = registerBlock(Blocks.WARPED_HANGING_SIGN, (block, item_properties) -> {
        return new HangingSignItem(block, Blocks.WARPED_WALL_HANGING_SIGN, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item BUCKET = registerItem("bucket", (item_properties) -> {
        return new BucketItem(Fluids.EMPTY, item_properties);
    }, (new Item.Properties()).stacksTo(16));
    public static final Item WATER_BUCKET = registerItem("water_bucket", (item_properties) -> {
        return new BucketItem(Fluids.WATER, item_properties);
    }, (new Item.Properties()).craftRemainder(Items.BUCKET).stacksTo(1));
    public static final Item LAVA_BUCKET = registerItem("lava_bucket", (item_properties) -> {
        return new BucketItem(Fluids.LAVA, item_properties);
    }, (new Item.Properties()).craftRemainder(Items.BUCKET).stacksTo(1));
    public static final Item POWDER_SNOW_BUCKET = registerItem("powder_snow_bucket", (item_properties) -> {
        return new SolidBucketItem(Blocks.POWDER_SNOW, SoundEvents.BUCKET_EMPTY_POWDER_SNOW, item_properties);
    ...
    public static final Item MILK_BUCKET = registerItem("milk_bucket", (new Item.Properties()).craftRemainder(Items.BUCKET).component(DataComponents.CONSUMABLE, Consumables.MILK_BUCKET).usingConvertsTo(Items.BUCKET).stacksTo(1));
    public static final Item PUFFERFISH_BUCKET = registerItem("pufferfish_bucket", (item_properties) -> {
        return new MobBucketItem(EntityType.PUFFERFISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, item_properties);
    ...
    public static final Item SALMON_BUCKET = registerItem("salmon_bucket", (item_properties) -> {
        return new MobBucketItem(EntityType.SALMON, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, item_properties);
    ...
    public static final Item COD_BUCKET = registerItem("cod_bucket", (item_properties) -> {
        return new MobBucketItem(EntityType.COD, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, item_properties);
    ...
    public static final Item TROPICAL_FISH_BUCKET = registerItem("tropical_fish_bucket", (item_properties) -> {
        return new MobBucketItem(EntityType.TROPICAL_FISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, item_properties);
    ...
    public static final Item AXOLOTL_BUCKET = registerItem("axolotl_bucket", (item_properties) -> {
        return new MobBucketItem(EntityType.AXOLOTL, Fluids.WATER, SoundEvents.BUCKET_EMPTY_AXOLOTL, item_properties);
    }, (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
    public static final Item TADPOLE_BUCKET = registerItem("tadpole_bucket", (item_properties) -> {
        return new MobBucketItem(EntityType.TADPOLE, Fluids.WATER, SoundEvents.BUCKET_EMPTY_TADPOLE, item_properties);
    }, (new Item.Properties()).stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
    ...
    public static final Item EGG = registerItem("egg", EggItem::new, (new Item.Properties()).stacksTo(16).component(DataComponents.CHICKEN_VARIANT, new EitherHolder(ChickenVariants.TEMPERATE)));
    public static final Item BLUE_EGG = registerItem("blue_egg", EggItem::new, (new Item.Properties()).stacksTo(16).component(DataComponents.CHICKEN_VARIANT, new EitherHolder(ChickenVariants.COLD)));
    public static final Item BROWN_EGG = registerItem("brown_egg", EggItem::new, (new Item.Properties()).stacksTo(16).component(DataComponents.CHICKEN_VARIANT, new EitherHolder(ChickenVariants.WARM)));
    ...
    public static final Item BUNDLE = registerItem("bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item WHITE_BUNDLE = registerItem("white_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item ORANGE_BUNDLE = registerItem("orange_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item MAGENTA_BUNDLE = registerItem("magenta_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item LIGHT_BLUE_BUNDLE = registerItem("light_blue_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item YELLOW_BUNDLE = registerItem("yellow_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item LIME_BUNDLE = registerItem("lime_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item PINK_BUNDLE = registerItem("pink_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item GRAY_BUNDLE = registerItem("gray_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item LIGHT_GRAY_BUNDLE = registerItem("light_gray_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item CYAN_BUNDLE = registerItem("cyan_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item PURPLE_BUNDLE = registerItem("purple_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item BLUE_BUNDLE = registerItem("blue_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item BROWN_BUNDLE = registerItem("brown_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item GREEN_BUNDLE = registerItem("green_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item RED_BUNDLE = registerItem("red_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    public static final Item BLACK_BUNDLE = registerItem("black_bundle", BundleItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY));
    ...
    public static final Item WHITE_DYE = registerItem("white_dye", (item_properties) -> {
        return new DyeItem(DyeColor.WHITE, item_properties);
    });
    public static final Item ORANGE_DYE = registerItem("orange_dye", (item_properties) -> {
        return new DyeItem(DyeColor.ORANGE, item_properties);
    });
    public static final Item MAGENTA_DYE = registerItem("magenta_dye", (item_properties) -> {
        return new DyeItem(DyeColor.MAGENTA, item_properties);
    });
    public static final Item LIGHT_BLUE_DYE = registerItem("light_blue_dye", (item_properties) -> {
        return new DyeItem(DyeColor.LIGHT_BLUE, item_properties);
    });
    public static final Item YELLOW_DYE = registerItem("yellow_dye", (item_properties) -> {
        return new DyeItem(DyeColor.YELLOW, item_properties);
    });
    public static final Item LIME_DYE = registerItem("lime_dye", (item_properties) -> {
        return new DyeItem(DyeColor.LIME, item_properties);
    });
    public static final Item PINK_DYE = registerItem("pink_dye", (item_properties) -> {
        return new DyeItem(DyeColor.PINK, item_properties);
    });
    public static final Item GRAY_DYE = registerItem("gray_dye", (item_properties) -> {
        return new DyeItem(DyeColor.GRAY, item_properties);
    });
    public static final Item LIGHT_GRAY_DYE = registerItem("light_gray_dye", (item_properties) -> {
        return new DyeItem(DyeColor.LIGHT_GRAY, item_properties);
    });
    public static final Item CYAN_DYE = registerItem("cyan_dye", (item_properties) -> {
        return new DyeItem(DyeColor.CYAN, item_properties);
    });
    public static final Item PURPLE_DYE = registerItem("purple_dye", (item_properties) -> {
        return new DyeItem(DyeColor.PURPLE, item_properties);
    });
    public static final Item BLUE_DYE = registerItem("blue_dye", (item_properties) -> {
        return new DyeItem(DyeColor.BLUE, item_properties);
    });
    public static final Item BROWN_DYE = registerItem("brown_dye", (item_properties) -> {
        return new DyeItem(DyeColor.BROWN, item_properties);
    });
    public static final Item GREEN_DYE = registerItem("green_dye", (item_properties) -> {
        return new DyeItem(DyeColor.GREEN, item_properties);
    });
    public static final Item RED_DYE = registerItem("red_dye", (item_properties) -> {
        return new DyeItem(DyeColor.RED, item_properties);
    });
    public static final Item BLACK_DYE = registerItem("black_dye", (item_properties) -> {
        return new DyeItem(DyeColor.BLACK, item_properties);
    });
    ...
    public static final Item CRAFTER = registerBlock(Blocks.CRAFTER, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item FILLED_MAP = registerItem("filled_map", MapItem::new, (new Item.Properties()).component(DataComponents.MAP_COLOR, MapItemColor.DEFAULT).component(DataComponents.MAP_DECORATIONS, MapDecorations.EMPTY));
    public static final Item SHEARS = registerItem("shears", ShearsItem::new, (new Item.Properties()).durability(238).component(DataComponents.TOOL, ShearsItem.createToolProperties()));
    ...
    public static final Item POTION = registerItem("potion", PotionItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).component(DataComponents.CONSUMABLE, Consumables.DEFAULT_DRINK).usingConvertsTo(Items.GLASS_BOTTLE));
    ...
    public static final Item BREWING_STAND = registerBlock(Blocks.BREWING_STAND, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    ...
    public static final Item EXPERIENCE_BOTTLE = registerItem("experience_bottle", ExperienceBottleItem::new, (new Item.Properties()).rarity(Rarity.UNCOMMON).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true));
    ...
    public static final Item WRITABLE_BOOK = registerItem("writable_book", WritableBookItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.WRITABLE_BOOK_CONTENT, WritableBookContent.EMPTY));
    public static final Item WRITTEN_BOOK = registerItem("written_book", WrittenBookItem::new, (new Item.Properties()).stacksTo(16).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true));
    public static final Item BREEZE_ROD = registerItem("breeze_rod");
    public static final Item MACE = registerItem("mace", MaceItem::new, (new Item.Properties()).rarity(Rarity.EPIC).durability(500).component(DataComponents.TOOL, MaceItem.createToolProperties()).repairable(Items.BREEZE_ROD).attributes(MaceItem.createAttributes()).enchantable(15).component(DataComponents.WEAPON, new Weapon(1)));
    public static final Item ITEM_FRAME = registerItem("item_frame", (item_properties) -> {
        return new ItemFrameItem(EntityType.ITEM_FRAME, item_properties);
    });
    public static final Item GLOW_ITEM_FRAME = registerItem("glow_item_frame", (item_properties) -> {
        return new ItemFrameItem(EntityType.GLOW_ITEM_FRAME, item_properties);
    });
    ...
    public static final Item SKELETON_SKULL = registerBlock(Blocks.SKELETON_SKULL, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.SKELETON_WALL_SKULL, Direction.DOWN, Waypoint.addHideAttribute(item_properties));
    }, (new Item.Properties()).rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item WITHER_SKELETON_SKULL = registerBlock(Blocks.WITHER_SKELETON_SKULL, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.WITHER_SKELETON_WALL_SKULL, Direction.DOWN, Waypoint.addHideAttribute(item_properties));
    }, (new Item.Properties()).rarity(Rarity.RARE).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item PLAYER_HEAD = registerBlock(Blocks.PLAYER_HEAD, (block, item_properties) -> {
        return new PlayerHeadItem(block, Blocks.PLAYER_WALL_HEAD, Waypoint.addHideAttribute(item_properties));
    }, (new Item.Properties()).rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item ZOMBIE_HEAD = registerBlock(Blocks.ZOMBIE_HEAD, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.ZOMBIE_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(item_properties));
    }, (new Item.Properties()).rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item CREEPER_HEAD = registerBlock(Blocks.CREEPER_HEAD, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.CREEPER_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(item_properties));
    }, (new Item.Properties()).rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item DRAGON_HEAD = registerBlock(Blocks.DRAGON_HEAD, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.DRAGON_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(item_properties));
    }, (new Item.Properties()).rarity(Rarity.EPIC).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item PIGLIN_HEAD = registerBlock(Blocks.PIGLIN_HEAD, (block, item_properties) -> {
        return new StandingAndWallBlockItem(block, Blocks.PIGLIN_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(item_properties));
    }, (new Item.Properties()).rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item NETHER_STAR = registerItem("nether_star", (new Item.Properties()).rarity(Rarity.RARE).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true).component(DataComponents.DAMAGE_RESISTANT, new DamageResistant(DamageTypeTags.IS_EXPLOSION)));
    public static final Item PUMPKIN_PIE = registerItem("pumpkin_pie", (new Item.Properties()).food(Foods.PUMPKIN_PIE));
    public static final Item FIREWORK_ROCKET = registerItem("firework_rocket", FireworkRocketItem::new, (new Item.Properties()).component(DataComponents.FIREWORKS, new Fireworks(1, List.of())));
    public static final Item FIREWORK_STAR = registerItem("firework_star");
    public static final Item ENCHANTED_BOOK = registerItem("enchanted_book", (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).component(DataComponents.STORED_ENCHANTMENTS, ItemEnchantments.EMPTY).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true));
    public static final Item NETHER_BRICK = registerItem("nether_brick");
    public static final Item RESIN_BRICK = registerItem("resin_brick", (new Item.Properties()).trimMaterial(TrimMaterials.RESIN));
    ...
    public static final Item RABBIT_STEW = registerItem("rabbit_stew", (new Item.Properties()).stacksTo(1).food(Foods.RABBIT_STEW).usingConvertsTo(Items.BOWL));
    ...
    public static final Item COMMAND_BLOCK_MINECART = registerItem("command_block_minecart", (item_properties) -> {
        return new MinecartItem(EntityType.COMMAND_BLOCK_MINECART, item_properties);
    ...
    public static final Item WHITE_BANNER = registerBlock(Blocks.WHITE_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.WHITE_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item ORANGE_BANNER = registerBlock(Blocks.ORANGE_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.ORANGE_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item MAGENTA_BANNER = registerBlock(Blocks.MAGENTA_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.MAGENTA_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item LIGHT_BLUE_BANNER = registerBlock(Blocks.LIGHT_BLUE_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.LIGHT_BLUE_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item YELLOW_BANNER = registerBlock(Blocks.YELLOW_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.YELLOW_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item LIME_BANNER = registerBlock(Blocks.LIME_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.LIME_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item PINK_BANNER = registerBlock(Blocks.PINK_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.PINK_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item GRAY_BANNER = registerBlock(Blocks.GRAY_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.GRAY_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item LIGHT_GRAY_BANNER = registerBlock(Blocks.LIGHT_GRAY_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.LIGHT_GRAY_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item CYAN_BANNER = registerBlock(Blocks.CYAN_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.CYAN_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item PURPLE_BANNER = registerBlock(Blocks.PURPLE_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.PURPLE_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item BLUE_BANNER = registerBlock(Blocks.BLUE_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.BLUE_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item BROWN_BANNER = registerBlock(Blocks.BROWN_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.BROWN_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item GREEN_BANNER = registerBlock(Blocks.GREEN_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.GREEN_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item RED_BANNER = registerBlock(Blocks.RED_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.RED_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item BLACK_BANNER = registerBlock(Blocks.BLACK_BANNER, (block, item_properties) -> {
        return new BannerItem(block, Blocks.BLACK_WALL_BANNER, item_properties);
    }, (new Item.Properties()).stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    ...
    public static final Item BEETROOT_SOUP = registerItem("beetroot_soup", (new Item.Properties()).stacksTo(1).food(Foods.BEETROOT_SOUP).usingConvertsTo(Items.BOWL));
    public static final Item DRAGON_BREATH = registerItem("dragon_breath", (new Item.Properties()).craftRemainder(Items.GLASS_BOTTLE).rarity(Rarity.UNCOMMON));
    public static final Item SPLASH_POTION = registerItem("splash_potion", SplashPotionItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY));
    public static final Item SPECTRAL_ARROW = registerItem("spectral_arrow", SpectralArrowItem::new);
    public static final Item TIPPED_ARROW = registerItem("tipped_arrow", TippedArrowItem::new, (new Item.Properties()).component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).component(DataComponents.POTION_DURATION_SCALE, 0.125F));
    public static final Item LINGERING_POTION = registerItem("lingering_potion", LingeringPotionItem::new, (new Item.Properties()).stacksTo(1).component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).component(DataComponents.POTION_DURATION_SCALE, 0.25F));
    public static final Item SHIELD = registerItem("shield", ShieldItem::new, (new Item.Properties()).durability(336).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY).repairable(ItemTags.WOODEN_TOOL_MATERIALS).equippableUnswappable(EquipmentSlot.OFFHAND).component(DataComponents.BLOCKS_ATTACKS, new BlocksAttacks(0.25F, 1.0F, List.of(new BlocksAttacks.DamageReduction(90.0F, Optional.empty(), 0.0F, 1.0F)), new BlocksAttacks.ItemDamageFunction(3.0F, 1.0F, 1.0F), Optional.of(DamageTypeTags.BYPASSES_SHIELD), Optional.of(SoundEvents.SHIELD_BLOCK), Optional.of(SoundEvents.SHIELD_BREAK))).component(DataComponents.BREAK_SOUND, SoundEvents.SHIELD_BREAK));
    ...
    public static final Item STONE_SPEAR = registerItem("stone_spear", (new Item.Properties()).spear(ToolMaterial.STONE, 0.75F, 0.82F, 0.7F, 4.5F, 10.0F, 9.0F, 5.1F, 13.75F, 4.6F));
    public static final Item COPPER_SPEAR = registerItem("copper_spear", (new Item.Properties()).spear(ToolMaterial.COPPER, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F));
    public static final Item IRON_SPEAR = registerItem("iron_spear", (new Item.Properties()).spear(ToolMaterial.IRON, 0.95F, 0.95F, 0.6F, 2.5F, 8.0F, 6.75F, 5.1F, 11.25F, 4.6F));
    public static final Item GOLDEN_SPEAR = registerItem("golden_spear", (new Item.Properties()).spear(ToolMaterial.GOLD, 0.95F, 0.7F, 0.7F, 3.5F, 10.0F, 8.5F, 5.1F, 13.75F, 4.6F));
    public static final Item DIAMOND_SPEAR = registerItem("diamond_spear", (new Item.Properties()).spear(ToolMaterial.DIAMOND, 1.05F, 1.075F, 0.5F, 3.0F, 7.5F, 6.5F, 5.1F, 10.0F, 4.6F));
    public static final Item NETHERITE_SPEAR = registerItem("netherite_spear", (new Item.Properties()).spear(ToolMaterial.NETHERITE, 1.15F, 1.2F, 0.4F, 2.5F, 7.0F, 5.5F, 5.1F, 8.75F, 4.6F).fireResistant());
    public static final Item TOTEM_OF_UNDYING = registerItem("totem_of_undying", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).component(DataComponents.DEATH_PROTECTION, DeathProtection.TOTEM_OF_UNDYING));
    ...
    public static final Item KNOWLEDGE_BOOK = registerItem("knowledge_book", KnowledgeBookItem::new, (new Item.Properties()).stacksTo(1).rarity(Rarity.EPIC).component(DataComponents.RECIPES, List.of()));
    public static final Item DEBUG_STICK = registerItem("debug_stick", DebugStickItem::new, (new Item.Properties()).stacksTo(1).rarity(Rarity.EPIC).component(DataComponents.DEBUG_STICK_STATE, DebugStickState.EMPTY).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true));
    ...
    public static final Item MUSIC_DISC_CAT = registerItem("music_disc_cat", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.CAT));
    public static final Item MUSIC_DISC_BLOCKS = registerItem("music_disc_blocks", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.BLOCKS));
    public static final Item MUSIC_DISC_CHIRP = registerItem("music_disc_chirp", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.CHIRP));
    public static final Item MUSIC_DISC_CREATOR = registerItem("music_disc_creator", (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(JukeboxSongs.CREATOR));
    public static final Item MUSIC_DISC_CREATOR_MUSIC_BOX = registerItem("music_disc_creator_music_box", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.CREATOR_MUSIC_BOX));
    public static final Item MUSIC_DISC_FAR = registerItem("music_disc_far", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.FAR));
    public static final Item MUSIC_DISC_LAVA_CHICKEN = registerItem("music_disc_lava_chicken", (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(JukeboxSongs.LAVA_CHICKEN));
    public static final Item MUSIC_DISC_MALL = registerItem("music_disc_mall", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.MALL));
    public static final Item MUSIC_DISC_MELLOHI = registerItem("music_disc_mellohi", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.MELLOHI));
    public static final Item MUSIC_DISC_STAL = registerItem("music_disc_stal", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.STAL));
    public static final Item MUSIC_DISC_STRAD = registerItem("music_disc_strad", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.STRAD));
    public static final Item MUSIC_DISC_WARD = registerItem("music_disc_ward", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.WARD));
    ...
    public static final Item MUSIC_DISC_WAIT = registerItem("music_disc_wait", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.WAIT));
    public static final Item MUSIC_DISC_OTHERSIDE = registerItem("music_disc_otherside", (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(JukeboxSongs.OTHERSIDE));
    public static final Item MUSIC_DISC_RELIC = registerItem("music_disc_relic", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.RELIC));
    ...
    public static final Item MUSIC_DISC_PIGSTEP = registerItem("music_disc_pigstep", (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(JukeboxSongs.PIGSTEP));
    public static final Item MUSIC_DISC_PRECIPICE = registerItem("music_disc_precipice", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.PRECIPICE));
    public static final Item MUSIC_DISC_TEARS = registerItem("music_disc_tears", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.TEARS));
    ...
    public static final Item TRIDENT = registerItem("trident", TridentItem::new, (new Item.Properties()).rarity(Rarity.RARE).durability(250).attributes(TridentItem.createAttributes()).component(DataComponents.TOOL, TridentItem.createToolProperties()).enchantable(1).component(DataComponents.WEAPON, new Weapon(1)));
    ...
    public static final Item CROSSBOW = registerItem("crossbow", CrossbowItem::new, (new Item.Properties()).stacksTo(1).durability(465).component(DataComponents.CHARGED_PROJECTILES, ChargedProjectiles.EMPTY).enchantable(1));
    public static final Item SUSPICIOUS_STEW = registerItem("suspicious_stew", (new Item.Properties()).stacksTo(1).food(Foods.SUSPICIOUS_STEW).component(DataComponents.SUSPICIOUS_STEW_EFFECTS, SuspiciousStewEffects.EMPTY).usingConvertsTo(Items.BOWL));
    public static final Item LOOM = registerBlock(Blocks.LOOM);
    public static final Item FLOWER_BANNER_PATTERN = registerItem("flower_banner_pattern", (new Item.Properties()).stacksTo(1).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_FLOWER));
    public static final Item CREEPER_BANNER_PATTERN = registerItem("creeper_banner_pattern", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_CREEPER));
    public static final Item SKULL_BANNER_PATTERN = registerItem("skull_banner_pattern", (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_SKULL));
    public static final Item MOJANG_BANNER_PATTERN = registerItem("mojang_banner_pattern", (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_MOJANG));
    public static final Item GLOBE_BANNER_PATTERN = registerItem("globe_banner_pattern", (new Item.Properties()).stacksTo(1).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_GLOBE));
    public static final Item PIGLIN_BANNER_PATTERN = registerItem("piglin_banner_pattern", (new Item.Properties()).stacksTo(1).rarity(Rarity.UNCOMMON).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_PIGLIN));
    public static final Item FLOW_BANNER_PATTERN = registerItem("flow_banner_pattern", (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_FLOW));
    public static final Item GUSTER_BANNER_PATTERN = registerItem("guster_banner_pattern", (new Item.Properties()).stacksTo(1).rarity(Rarity.RARE).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_GUSTER));
    public static final Item FIELD_MASONED_BANNER_PATTERN = registerItem("field_masoned_banner_pattern", (new Item.Properties()).stacksTo(1).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_FIELD_MASONED));
    public static final Item BORDURE_INDENTED_BANNER_PATTERN = registerItem("bordure_indented_banner_pattern", (new Item.Properties()).stacksTo(1).component(DataComponents.PROVIDES_BANNER_PATTERNS, BannerPatternTags.PATTERN_ITEM_BORDURE_INDENTED));
    public static final Item GOAT_HORN = registerItem("goat_horn", InstrumentItem::new, (new Item.Properties()).rarity(Rarity.UNCOMMON).stacksTo(1).component(DataComponents.INSTRUMENT, new InstrumentComponent(Instruments.PONDER_GOAT_HORN)));
    public static final Item COMPOSTER = registerBlock(Blocks.COMPOSTER);
    public static final Item BARREL = registerBlock(Blocks.BARREL, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item SMOKER = registerBlock(Blocks.SMOKER, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item BLAST_FURNACE = registerBlock(Blocks.BLAST_FURNACE, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    ...
    public static final WeatheringCopperItems COPPER_LANTERN = WeatheringCopperItems.create(Blocks.COPPER_LANTERN, Items::registerBlock);
    ...
    public static final Item CAMPFIRE = registerBlock(Blocks.CAMPFIRE, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    public static final Item SOUL_CAMPFIRE = registerBlock(Blocks.SOUL_CAMPFIRE, (item_properties) -> {
        return item_properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
    });
    ...
    public static final Item BEE_NEST = registerBlock(Blocks.BEE_NEST, (new Item.Properties()).component(DataComponents.BEES, Bees.EMPTY).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(BeehiveBlock.HONEY_LEVEL, 0)));
    public static final Item BEEHIVE = registerBlock(Blocks.BEEHIVE, (new Item.Properties()).component(DataComponents.BEES, Bees.EMPTY).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(BeehiveBlock.HONEY_LEVEL, 0)));
    public static final Item HONEY_BOTTLE = registerItem("honey_bottle", (new Item.Properties()).craftRemainder(Items.GLASS_BOTTLE).food(Foods.HONEY_BOTTLE, Consumables.HONEY_BOTTLE).usingConvertsTo(Items.GLASS_BOTTLE).stacksTo(16));
    ...
    public static final Item NETHERITE_UPGRADE_SMITHING_TEMPLATE = registerItem("netherite_upgrade_smithing_template", SmithingTemplateItem::createNetheriteUpgradeTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item SENTRY_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("sentry_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item DUNE_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("dune_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item COAST_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("coast_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item WILD_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("wild_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item WARD_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("ward_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.RARE));
    public static final Item EYE_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("eye_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.RARE));
    public static final Item VEX_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("vex_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.RARE));
    public static final Item TIDE_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("tide_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item SNOUT_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("snout_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item RIB_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("rib_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item SPIRE_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("spire_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.RARE));
    public static final Item WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("wayfinder_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item SHAPER_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("shaper_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item SILENCE_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("silence_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.EPIC));
    public static final Item RAISER_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("raiser_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item HOST_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("host_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item FLOW_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("flow_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    public static final Item BOLT_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem("bolt_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, (new Item.Properties()).rarity(Rarity.UNCOMMON));
    ...
    public static final Item COPPER_CHEST = registerBlock(Blocks.COPPER_CHEST);
    public static final Item EXPOSED_COPPER_CHEST = registerBlock(Blocks.EXPOSED_COPPER_CHEST);
    public static final Item WEATHERED_COPPER_CHEST = registerBlock(Blocks.WEATHERED_COPPER_CHEST);
    public static final Item OXIDIZED_COPPER_CHEST = registerBlock(Blocks.OXIDIZED_COPPER_CHEST);
    public static final Item WAXED_COPPER_CHEST = registerBlock(Blocks.WAXED_COPPER_CHEST);
    public static final Item WAXED_EXPOSED_COPPER_CHEST = registerBlock(Blocks.WAXED_EXPOSED_COPPER_CHEST);
    public static final Item WAXED_WEATHERED_COPPER_CHEST = registerBlock(Blocks.WAXED_WEATHERED_COPPER_CHEST);
    public static final Item WAXED_OXIDIZED_COPPER_CHEST = registerBlock(Blocks.WAXED_OXIDIZED_COPPER_CHEST);
    public static final Item COPPER_GOLEM_STATUE = registerBlock(Blocks.COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item EXPOSED_COPPER_GOLEM_STATUE = registerBlock(Blocks.EXPOSED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item WEATHERED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WEATHERED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item OXIDIZED_COPPER_GOLEM_STATUE = registerBlock(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item WAXED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item WAXED_EXPOSED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item WAXED_WEATHERED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item WAXED_OXIDIZED_COPPER_GOLEM_STATUE = registerBlock(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, (new Item.Properties()).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    ...
    public static final Item OMINOUS_BOTTLE = registerItem("ominous_bottle", (new Item.Properties()).rarity(Rarity.UNCOMMON).component(DataComponents.CONSUMABLE, Consumables.OMINOUS_BOTTLE).component(DataComponents.OMINOUS_BOTTLE_AMPLIFIER, new OminousBottleAmplifier(0)));

    public Items() {}

    private static Function<Item.Properties, Item> createBlockItemWithCustomItemName(Block block) {
        return (item_properties) -> {
            return new BlockItem(block, item_properties.useItemDescriptionPrefix());
        };
    }
    ...
    public static Item registerBlock(Block block, UnaryOperator<Item.Properties> propertiesFunction) {
        return registerBlock(block, (block1, item_properties) -> {
            return new BlockItem(block1, (Item.Properties) propertiesFunction.apply(item_properties));
        });
    }
    ...
    public static Item registerBlock(Block block, BiFunction<Block, Item.Properties, Item> itemFactory) {
        return registerBlock(block, itemFactory, new Item.Properties());
    }

    public static Item registerBlock(Block block, BiFunction<Block, Item.Properties, Item> itemFactory, Item.Properties properties) {
        return registerItem(blockIdToItemId(block.builtInRegistryHolder().key()), (item_properties1) -> {
            return (Item) itemFactory.apply(block, item_properties1);
    ...
    public static Item registerItem(ResourceKey<Item> key, Function<Item.Properties, Item> itemFactory) {
