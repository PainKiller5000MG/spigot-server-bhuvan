...
public enum Difficulty implements StringRepresentable {
    ...
    public static final StreamCodec<ByteBuf, Difficulty> STREAM_CODEC = ByteBufCodecs.idMapper(Difficulty.BY_ID, Difficulty::getId);
    ...
    public static Difficulty byId(int id) {
        return (Difficulty) Difficulty.BY_ID.apply(id);
    }
