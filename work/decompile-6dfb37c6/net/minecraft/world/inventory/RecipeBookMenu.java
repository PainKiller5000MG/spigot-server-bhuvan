...
public abstract class RecipeBookMenu extends AbstractContainerMenu {
    ...
    public abstract RecipeBookMenu.PostPlaceAction handlePlacement(boolean useMaxItems, boolean allowDroppingItemsToClear, RecipeHolder<?> recipe, ServerLevel level, Inventory inventory);
