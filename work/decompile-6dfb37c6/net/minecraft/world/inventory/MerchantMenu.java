...
public class MerchantMenu extends AbstractContainerMenu {
    ...
    private void moveFromInventoryToPaymentSlot(int paymentSlot, ItemCost cost) {
        for (int j = 3; j < 39; ++j) {
            ...
            if (!itemstack.isEmpty() && cost.test(itemstack)) {
                ItemStack itemstack1 = this.tradeContainer.getItem(paymentSlot);
                ...
                if (itemstack1.isEmpty() || ItemStack.isSameItemSameComponents(itemstack, itemstack1)) {
                    ...
                    itemstack.shrink(l);
                    this.tradeContainer.setItem(paymentSlot, itemstack2);
