...
public class NautilusInventoryMenu extends AbstractMountInventoryMenu {
    ...
    public NautilusInventoryMenu(int containerId, Inventory playerInventory, Container nautilusInventory, final AbstractNautilus nautilus, int inventoryColumns) {
        ...
        Container container1 = nautilus.createEquipmentSlotContainer(EquipmentSlot.SADDLE);

        this.addSlot(new ArmorSlot(container1, nautilus, EquipmentSlot.SADDLE, 0, 8, 18, NautilusInventoryMenu.SADDLE_SLOT_SPRITE) {
            @Override
            public boolean isActive() {
                return nautilus.canUseSlot(EquipmentSlot.SADDLE);
            }
        });
        Container container2 = nautilus.createEquipmentSlotContainer(EquipmentSlot.BODY);

        this.addSlot(new ArmorSlot(container2, nautilus, EquipmentSlot.BODY, 0, 8, 36, NautilusInventoryMenu.ARMOR_SLOT_SPRITE) {
            @Override
            public boolean isActive() {
