...
public class IndirectMerger implements IndexMerger {
    ...
    public IndirectMerger(DoubleList first, DoubleList second, boolean firstOnlyMatters, boolean secondOnlyMatters) {
        ...
        boolean flag2 = !firstOnlyMatters;
        boolean flag3 = !secondOnlyMatters;
        int l = 0;
        int i1 = 0;
        int j1 = 0;
        ...
        while (true) {
            ...
            boolean flag6 = !flag4 && (flag5 || first.getDouble(i1) < second.getDouble(j1) + 1.0E-7D);
            ...
            int k1 = i1 - 1;
            int l1 = j1 - 1;
            double d1 = flag6 ? first.getDouble(k1) : second.getDouble(l1);
    ...
    public DoubleList getList() {
        return (DoubleList) (this.resultLength <= 1 ? IndirectMerger.EMPTY : DoubleArrayList.wrap(this.result, this.resultLength));
    }
}
