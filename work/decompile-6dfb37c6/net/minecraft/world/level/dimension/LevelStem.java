...
public record LevelStem(Holder<DimensionType> type, ChunkGenerator generator) {
    ...
    public static final Codec<LevelStem> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(DimensionType.CODEC.fieldOf("type").forGetter(LevelStem::type), ChunkGenerator.CODEC.fieldOf("generator").forGetter(LevelStem::generator)).apply(instance, instance.stable(LevelStem::new));
    });
