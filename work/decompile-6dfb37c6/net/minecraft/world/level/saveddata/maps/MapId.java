...
public record MapId(int id) implements TooltipProvider {
    ...
    public void addToTooltip(Item.TooltipContext context, Consumer<Component> consumer, TooltipFlag flag, DataComponentGetter components) {
        ...
        if (mapitemsaveddata == null) {
            ...
            MapPostProcessing mappostprocessing = (MapPostProcessing) components.get(DataComponents.MAP_POST_PROCESSING);

            if (components.get(DataComponents.CUSTOM_NAME) == null && mappostprocessing == null) {
