    ...
    private void ensureActiveIsNotIterated() {
        if (this.iterated == this.active) {
            ...
            while (objectiterator.hasNext()) {
                Int2ObjectMap.Entry<Entity> int2objectmap_entry = (Entry) objectiterator.next();

                this.passive.put(int2objectmap_entry.getIntKey(), (Entity) int2objectmap_entry.getValue());
            }
