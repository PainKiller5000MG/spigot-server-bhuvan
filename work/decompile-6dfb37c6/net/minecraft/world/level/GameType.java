...
public enum GameType implements StringRepresentable {
    ...
    public static final StreamCodec<ByteBuf, GameType> STREAM_CODEC = ByteBufCodecs.idMapper(GameType.BY_ID, GameType::getId);
    /** @deprecated */
    @Deprecated
    ...
    public static GameType byId(int id) {
        return (GameType) GameType.BY_ID.apply(id);
    }

    public static GameType byName(String name) {
        return byName(name, GameType.SURVIVAL);
    }

    @Contract("_,!null->!null;_,null->_")
    public static @Nullable GameType byName(String name, @Nullable GameType defaultMode) {
        GameType gametype1 = GameType.CODEC.byName(name);

        return gametype1 != null ? gametype1 : defaultMode;
    }
    ...
    public static boolean isValidId(int id) {
        return Arrays.stream(values()).anyMatch((gametype) -> {
