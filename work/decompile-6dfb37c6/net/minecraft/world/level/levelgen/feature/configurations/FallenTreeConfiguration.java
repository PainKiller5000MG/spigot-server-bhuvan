...
public class FallenTreeConfiguration implements FeatureConfiguration {
    ...
    public static final Codec<FallenTreeConfiguration> CODEC = RecordCodecBuilder.create((instance) -> {
        ...
        }), TreeDecorator.CODEC.listOf().fieldOf("stump_decorators").forGetter((fallentreeconfiguration) -> {
            return fallentreeconfiguration.stumpDecorators;
        }), TreeDecorator.CODEC.listOf().fieldOf("log_decorators").forGetter((fallentreeconfiguration) -> {
