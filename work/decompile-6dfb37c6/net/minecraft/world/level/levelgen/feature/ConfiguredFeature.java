...
public record ConfiguredFeature<FC extends FeatureConfiguration, F extends Feature<FC>>(F feature, FC config) {
    ...
    public static final Codec<Holder<ConfiguredFeature<?, ?>>> CODEC = RegistryFileCodec.<Holder<ConfiguredFeature<?, ?>>>create(Registries.CONFIGURED_FEATURE, ConfiguredFeature.DIRECT_CODEC);
    public static final Codec<HolderSet<ConfiguredFeature<?, ?>>> LIST_CODEC = RegistryCodecs.homogeneousList(Registries.CONFIGURED_FEATURE, ConfiguredFeature.DIRECT_CODEC);
    ...
    public String toString() {
        String s = String.valueOf(this.feature);

        return "Configured: " + s + ": " + String.valueOf(this.config);
    }
}
