...
public class ThreeLayersFeatureSize extends FeatureSize {
    ...
    public static final MapCodec<ThreeLayersFeatureSize> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
    ...
    public int getSizeAtHeight(int treeHeight, int yo) {
        return yo < this.limit ? this.lowerSize : (yo >= treeHeight - this.upperLimit ? this.upperSize : this.middleSize);
    }
}
