...
public class LayerConfiguration implements FeatureConfiguration {
    ...
    public static final Codec<LayerConfiguration> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(Codec.intRange(0, DimensionType.Y_SIZE).fieldOf("height").forGetter((layerconfiguration) -> {
            return layerconfiguration.height;
        }), BlockState.CODEC.fieldOf("state").forGetter((layerconfiguration) -> {
