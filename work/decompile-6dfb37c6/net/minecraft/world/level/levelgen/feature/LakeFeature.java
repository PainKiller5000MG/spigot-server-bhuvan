...
public class LakeFeature extends Feature<LakeFeature.Configuration> {
    ...
    public boolean place(FeaturePlaceContext<LakeFeature.Configuration> context) {
        ...
        LakeFeature.Configuration lakefeature_configuration = context.config();
                    ...
                    for (int k2 = 0; k2 < 8; ++k2) {
                        if (aboolean[(i2 * 16 + j2) * 8 + k2]) {
                            ...
                            if (this.canReplaceBlock(worldgenlevel.getBlockState(blockpos1))) {
                                ...
                                worldgenlevel.setBlock(blockpos1, flag1 ? LakeFeature.AIR : blockstate, 2);
                                if (flag1) {
                                    worldgenlevel.scheduleTick(blockpos1, LakeFeature.AIR.getBlock(), 0);
            ...
            if (blockstate.getFluidState().is(FluidTags.WATER)) {
                for (int k3 = 0; k3 < 16; ++k3) {
                    for (int l3 = 0; l3 < 16; ++l3) {
                        ...
                        if (((Biome) worldgenlevel.getBiome(blockpos3).value()).shouldFreeze(worldgenlevel, blockpos3, false) && this.canReplaceBlock(worldgenlevel.getBlockState(blockpos3))) {
