...
public class WeightedStateProvider extends BlockStateProvider {
    ...
    public static final MapCodec<WeightedStateProvider> CODEC = WeightedList.nonEmptyCodec(BlockState.CODEC).comapFlatMap(WeightedStateProvider::create, (weightedstateprovider) -> {
