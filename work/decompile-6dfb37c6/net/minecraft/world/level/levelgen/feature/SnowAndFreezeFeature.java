    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        for (int i = 0; i < 16; ++i) {
            for (int j = 0; j < 16; ++j) {
                ...
                Biome biome = (Biome) worldgenlevel.getBiome(blockpos_mutableblockpos).value();
                ...
                if (biome.shouldSnow(worldgenlevel, blockpos_mutableblockpos)) {
                    ...
                    if (blockstate.hasProperty(SnowyDirtBlock.SNOWY)) {
                        worldgenlevel.setBlock(blockpos_mutableblockpos1, (BlockState) blockstate.setValue(SnowyDirtBlock.SNOWY, true), 2);
                    }
                }
            }
        }
