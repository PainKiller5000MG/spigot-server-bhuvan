...
public record NoiseGeneratorSettings(NoiseSettings noiseSettings, BlockState defaultBlock, BlockState defaultFluid, NoiseRouter noiseRouter, SurfaceRules.RuleSource surfaceRule, List<Climate.ParameterPoint> spawnTarget, int seaLevel, boolean disableMobGeneration, boolean aquifersEnabled, boolean oreVeinsEnabled, boolean useLegacyRandomSource) {
    ...
    public static void bootstrap(BootstrapContext<NoiseGeneratorSettings> context) {
        context.register(NoiseGeneratorSettings.OVERWORLD, overworld(context, false, false));
        context.register(NoiseGeneratorSettings.LARGE_BIOMES, overworld(context, false, true));
        context.register(NoiseGeneratorSettings.AMPLIFIED, overworld(context, true, false));
        context.register(NoiseGeneratorSettings.NETHER, nether(context));
        context.register(NoiseGeneratorSettings.END, end(context));
        context.register(NoiseGeneratorSettings.CAVES, caves(context));
        context.register(NoiseGeneratorSettings.FLOATING_ISLANDS, floatingIslands(context));
    }
