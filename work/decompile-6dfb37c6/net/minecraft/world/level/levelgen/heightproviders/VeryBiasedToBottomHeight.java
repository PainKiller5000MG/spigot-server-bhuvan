...
public class VeryBiasedToBottomHeight extends HeightProvider {
    ...
    public static final MapCodec<VeryBiasedToBottomHeight> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
    ...
    public String toString() {
        ...
        return "biased[" + s + "-" + String.valueOf(this.maxInclusive) + " inner: " + this.inner + "]";
    }
}
