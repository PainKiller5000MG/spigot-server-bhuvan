...
public class NetherFortressStructure extends Structure {
    ...
    private static void generatePieces(StructurePiecesBuilder builder, Structure.GenerationContext context) {
        NetherFortressPieces.StartPiece netherfortresspieces_startpiece = new NetherFortressPieces.StartPiece(context.random(), context.chunkPos().getBlockX(2), context.chunkPos().getBlockZ(2));

        builder.addPiece(netherfortresspieces_startpiece);
        netherfortresspieces_startpiece.addChildren(netherfortresspieces_startpiece, builder, context.random());
        ...
        while (!list.isEmpty()) {
            ...
            structurepiece.addChildren(netherfortresspieces_startpiece, builder, context.random());
        }
