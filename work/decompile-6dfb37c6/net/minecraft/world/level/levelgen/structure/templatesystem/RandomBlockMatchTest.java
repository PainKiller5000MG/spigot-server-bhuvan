...
public class RandomBlockMatchTest extends RuleTest {
    ...
    public static final MapCodec<RandomBlockMatchTest> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(BuiltInRegistries.BLOCK.byNameCodec().fieldOf("block").forGetter((randomblockmatchtest) -> {
