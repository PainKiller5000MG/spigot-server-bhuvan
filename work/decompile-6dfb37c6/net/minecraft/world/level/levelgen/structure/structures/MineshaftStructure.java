...
public class MineshaftStructure extends Structure {
    ...
    public static final MapCodec<MineshaftStructure> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(settingsCodec(instance), MineshaftStructure.Type.CODEC.fieldOf("mineshaft_type").forGetter((mineshaftstructure) -> {
    ...
    private int generatePiecesAndAdjust(StructurePiecesBuilder builder, Structure.GenerationContext context) {
        ...
        builder.addPiece(mineshaftpieces_mineshaftroom);
        mineshaftpieces_mineshaftroom.addChildren(mineshaftpieces_mineshaftroom, builder, worldgenrandom);
    ...
    public static enum Type implements StringRepresentable {
        ...
        public static final Codec<MineshaftStructure.Type> CODEC = StringRepresentable.<MineshaftStructure.Type>fromEnum(MineshaftStructure.Type::values);
        private static final IntFunction<MineshaftStructure.Type> BY_ID = ByIdMap.<MineshaftStructure.Type>continuous(Enum::ordinal, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
        ...
        public static MineshaftStructure.Type byId(int id) {
            return (MineshaftStructure.Type) MineshaftStructure.Type.BY_ID.apply(id);
        }
