...
public class OceanMonumentStructure extends Structure {
    ...
    public static PiecesContainer regeneratePiecesAfterLoad(ChunkPos chunkPos, long seed, PiecesContainer savedPieces) {
        if (savedPieces.isEmpty()) {
            ...
            StructurePiece structurepiece = (StructurePiece) savedPieces.pieces().get(0);
            ...
            Direction direction1 = (Direction) Objects.requireNonNullElse(structurepiece.getOrientation(), direction);
