...
public interface StructureProcessorType<P extends StructureProcessor> {
    ...
    Codec<StructureProcessorList> LIST_OBJECT_CODEC = StructureProcessorType.SINGLE_CODEC.listOf().xmap(StructureProcessorList::new, StructureProcessorList::list);
    Codec<StructureProcessorList> DIRECT_CODEC = Codec.withAlternative(StructureProcessorType.LIST_OBJECT_CODEC.fieldOf("processors").codec(), StructureProcessorType.LIST_OBJECT_CODEC);
    Codec<Holder<StructureProcessorList>> LIST_CODEC = RegistryFileCodec.<Holder<StructureProcessorList>>create(Registries.PROCESSOR_LIST, StructureProcessorType.DIRECT_CODEC);
    ...
    static <P extends StructureProcessor> StructureProcessorType<P> register(String id, MapCodec<P> codec) {
        return (StructureProcessorType) Registry.register(BuiltInRegistries.STRUCTURE_PROCESSOR, id, (StructureProcessorType) () -> {
            return codec;
        });
    }
}
