...
public record ConfiguredWorldCarver<WC extends CarverConfiguration>(WorldCarver<WC> worldCarver, WC config) {
    ...
    public static final Codec<Holder<ConfiguredWorldCarver<?>>> CODEC = RegistryFileCodec.<Holder<ConfiguredWorldCarver<?>>>create(Registries.CONFIGURED_CARVER, ConfiguredWorldCarver.DIRECT_CODEC);
    public static final Codec<HolderSet<ConfiguredWorldCarver<?>>> LIST_CODEC = RegistryCodecs.homogeneousList(Registries.CONFIGURED_CARVER, ConfiguredWorldCarver.DIRECT_CODEC);
