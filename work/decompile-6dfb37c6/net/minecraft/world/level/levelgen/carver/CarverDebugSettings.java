...
public class CarverDebugSettings {
    ...
    public static final Codec<CarverDebugSettings> CODEC = RecordCodecBuilder.create((instance) -> {
        return instance.group(Codec.BOOL.optionalFieldOf("debug_mode", false).forGetter(CarverDebugSettings::isDebugMode), BlockState.CODEC.optionalFieldOf("air_state", CarverDebugSettings.DEFAULT.getAirState()).forGetter(CarverDebugSettings::getAirState), BlockState.CODEC.optionalFieldOf("water_state", CarverDebugSettings.DEFAULT.getAirState()).forGetter(CarverDebugSettings::getWaterState), BlockState.CODEC.optionalFieldOf("lava_state", CarverDebugSettings.DEFAULT.getAirState()).forGetter(CarverDebugSettings::getLavaState), BlockState.CODEC.optionalFieldOf("barrier_state", CarverDebugSettings.DEFAULT.getAirState()).forGetter(CarverDebugSettings::getBarrierState)).apply(instance, CarverDebugSettings::new);
    });
    ...
    public static CarverDebugSettings of(boolean debugMode, BlockState airState) {
        return new CarverDebugSettings(debugMode, airState, CarverDebugSettings.DEFAULT.getWaterState(), CarverDebugSettings.DEFAULT.getLavaState(), CarverDebugSettings.DEFAULT.getBarrierState());
    }
