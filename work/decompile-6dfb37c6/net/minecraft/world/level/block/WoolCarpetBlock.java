...
public class WoolCarpetBlock extends CarpetBlock {
    ...
    public static final MapCodec<WoolCarpetBlock> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(DyeColor.CODEC.fieldOf("color").forGetter(WoolCarpetBlock::getColor), propertiesCodec()).apply(instance, WoolCarpetBlock::new);
    });
    private final DyeColor color;

    @Override
    public MapCodec<WoolCarpetBlock> codec() {
        return WoolCarpetBlock.CODEC;
    }
