...
public abstract class GrowingPlantBlock extends Block {
    ...
    public @Nullable BlockState getStateForPlacement(BlockPlaceContext context) {
        ...
        return !blockstate.is(this.getHeadBlock()) && !blockstate.is(this.getBodyBlock()) ? this.getStateForPlacement(context.getLevel().random) : this.getBodyBlock().defaultBlockState();
    }
    ...
    protected boolean canSurvive(BlockState state, LevelReader level, BlockPos pos) {
        BlockPos blockpos1 = pos.relative(this.growthDirection.getOpposite());
        BlockState blockstate1 = level.getBlockState(blockpos1);

        return !this.canAttachTo(blockstate1) ? false : blockstate1.is(this.getHeadBlock()) || blockstate1.is(this.getBodyBlock()) || blockstate1.isFaceSturdy(level, blockpos1, this.growthDirection);
    }
