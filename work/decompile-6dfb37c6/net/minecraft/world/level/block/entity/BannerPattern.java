...
public record BannerPattern(Identifier assetId, String translationKey) {
    ...
    public static final Codec<Holder<BannerPattern>> CODEC = RegistryFileCodec.<Holder<BannerPattern>>create(Registries.BANNER_PATTERN, BannerPattern.DIRECT_CODEC);
    public static final StreamCodec<RegistryFriendlyByteBuf, Holder<BannerPattern>> STREAM_CODEC = ByteBufCodecs.holder(Registries.BANNER_PATTERN, BannerPattern.DIRECT_STREAM_CODEC);
}
