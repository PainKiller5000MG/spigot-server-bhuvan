...
public class BlockStateProperties {
    ...
    public static final EnumProperty<Direction.Axis> AXIS = EnumProperty.<Direction.Axis>create("axis", Direction.Axis.class);
    ...
    public static final EnumProperty<Direction> FACING = EnumProperty.create("facing", Direction.class, Direction.NORTH, Direction.EAST, Direction.SOUTH, Direction.WEST, Direction.UP, Direction.DOWN);
    public static final EnumProperty<Direction> FACING_HOPPER = EnumProperty.create("facing", Direction.class, (direction) -> {
    ...
    public static final EnumProperty<FrontAndTop> ORIENTATION = EnumProperty.<FrontAndTop>create("orientation", FrontAndTop.class);
    public static final EnumProperty<AttachFace> ATTACH_FACE = EnumProperty.<AttachFace>create("face", AttachFace.class);
    public static final EnumProperty<BellAttachType> BELL_ATTACHMENT = EnumProperty.<BellAttachType>create("attachment", BellAttachType.class);
    public static final EnumProperty<WallSide> EAST_WALL = EnumProperty.<WallSide>create("east", WallSide.class);
    public static final EnumProperty<WallSide> NORTH_WALL = EnumProperty.<WallSide>create("north", WallSide.class);
    public static final EnumProperty<WallSide> SOUTH_WALL = EnumProperty.<WallSide>create("south", WallSide.class);
    public static final EnumProperty<WallSide> WEST_WALL = EnumProperty.<WallSide>create("west", WallSide.class);
    public static final EnumProperty<RedstoneSide> EAST_REDSTONE = EnumProperty.<RedstoneSide>create("east", RedstoneSide.class);
    public static final EnumProperty<RedstoneSide> NORTH_REDSTONE = EnumProperty.<RedstoneSide>create("north", RedstoneSide.class);
    public static final EnumProperty<RedstoneSide> SOUTH_REDSTONE = EnumProperty.<RedstoneSide>create("south", RedstoneSide.class);
    public static final EnumProperty<RedstoneSide> WEST_REDSTONE = EnumProperty.<RedstoneSide>create("west", RedstoneSide.class);
    ...
    public static final EnumProperty<SideChainPart> SIDE_CHAIN_PART = EnumProperty.<SideChainPart>create("side_chain", SideChainPart.class);
    public static final EnumProperty<RailShape> RAIL_SHAPE = EnumProperty.<RailShape>create("shape", RailShape.class);
    public static final EnumProperty<RailShape> RAIL_SHAPE_STRAIGHT = EnumProperty.create("shape", RailShape.class, (railshape) -> {
    ...
    public static final EnumProperty<BedPart> BED_PART = EnumProperty.<BedPart>create("part", BedPart.class);
    public static final EnumProperty<ChestType> CHEST_TYPE = EnumProperty.<ChestType>create("type", ChestType.class);
    public static final EnumProperty<ComparatorMode> MODE_COMPARATOR = EnumProperty.<ComparatorMode>create("mode", ComparatorMode.class);
    public static final EnumProperty<DoorHingeSide> DOOR_HINGE = EnumProperty.<DoorHingeSide>create("hinge", DoorHingeSide.class);
    public static final EnumProperty<NoteBlockInstrument> NOTEBLOCK_INSTRUMENT = EnumProperty.<NoteBlockInstrument>create("instrument", NoteBlockInstrument.class);
    ...
    public static final EnumProperty<StructureMode> STRUCTUREBLOCK_MODE = EnumProperty.<StructureMode>create("mode", StructureMode.class);
    public static final EnumProperty<BambooLeaves> BAMBOO_LEAVES = EnumProperty.<BambooLeaves>create("leaves", BambooLeaves.class);
    public static final EnumProperty<Tilt> TILT = EnumProperty.<Tilt>create("tilt", Tilt.class);
    ...
    public static final EnumProperty<DripstoneThickness> DRIPSTONE_THICKNESS = EnumProperty.<DripstoneThickness>create("thickness", DripstoneThickness.class);
    public static final EnumProperty<SculkSensorPhase> SCULK_SENSOR_PHASE = EnumProperty.<SculkSensorPhase>create("sculk_sensor_phase", SculkSensorPhase.class);
    ...
    public static final EnumProperty<TrialSpawnerState> TRIAL_SPAWNER_STATE = EnumProperty.<TrialSpawnerState>create("trial_spawner_state", TrialSpawnerState.class);
    public static final EnumProperty<VaultState> VAULT_STATE = EnumProperty.<VaultState>create("vault_state", VaultState.class);
    public static final EnumProperty<CreakingHeartState> CREAKING_HEART_STATE = EnumProperty.<CreakingHeartState>create("creaking_heart_state", CreakingHeartState.class);
    public static final BooleanProperty OMINOUS = BooleanProperty.create("ominous");
    public static final EnumProperty<TestBlockMode> TEST_BLOCK_MODE = EnumProperty.<TestBlockMode>create("mode", TestBlockMode.class);
    public static final BooleanProperty MAP = BooleanProperty.create("map");
    public static final EnumProperty<CopperGolemStatueBlock.Pose> COPPER_GOLEM_POSE = EnumProperty.<CopperGolemStatueBlock.Pose>create("copper_golem_pose", CopperGolemStatueBlock.Pose.class);
