...
public enum DoubleBlockHalf implements StringRepresentable {
    ...
    UPPER(Direction.DOWN), LOWER(Direction.UP);
    ...
    public String getSerializedName() {
        return this == DoubleBlockHalf.UPPER ? "upper" : "lower";
    }

    public DoubleBlockHalf getOtherHalf() {
        return this == DoubleBlockHalf.UPPER ? DoubleBlockHalf.LOWER : DoubleBlockHalf.UPPER;
    }
}
