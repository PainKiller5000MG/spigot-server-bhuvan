...
public class StainedGlassBlock extends TransparentBlock implements BeaconBeamBlock {
    ...
    public static final MapCodec<StainedGlassBlock> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(DyeColor.CODEC.fieldOf("color").forGetter(StainedGlassBlock::getColor), propertiesCodec()).apply(instance, StainedGlassBlock::new);
    });
    private final DyeColor color;

    @Override
    public MapCodec<StainedGlassBlock> codec() {
        return StainedGlassBlock.CODEC;
    }
