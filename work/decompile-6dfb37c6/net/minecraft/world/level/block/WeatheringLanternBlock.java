...
public class WeatheringLanternBlock extends LanternBlock implements WeatheringCopper {
    ...
    public static final MapCodec<WeatheringLanternBlock> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(WeatheringCopper.WeatherState.CODEC.fieldOf("weathering_state").forGetter(WeatheringLanternBlock::getAge), propertiesCodec()).apply(instance, WeatheringLanternBlock::new);
    });
