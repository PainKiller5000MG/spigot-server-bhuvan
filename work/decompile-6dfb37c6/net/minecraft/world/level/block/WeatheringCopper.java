...
public interface WeatheringCopper extends ChangeOverTimeBlock<WeatheringCopper.WeatherState> {
    ...
    public static enum WeatherState implements StringRepresentable {
        ...
        public static final IntFunction<WeatheringCopper.WeatherState> BY_ID = ByIdMap.<WeatheringCopper.WeatherState>continuous(Enum::ordinal, values(), ByIdMap.OutOfBoundsStrategy.CLAMP);
        public static final Codec<WeatheringCopper.WeatherState> CODEC = StringRepresentable.<WeatheringCopper.WeatherState>fromEnum(WeatheringCopper.WeatherState::values);
        public static final StreamCodec<ByteBuf, WeatheringCopper.WeatherState> STREAM_CODEC = ByteBufCodecs.idMapper(WeatheringCopper.WeatherState.BY_ID, Enum::ordinal);
        ...
        public WeatheringCopper.WeatherState next() {
            return (WeatheringCopper.WeatherState) WeatheringCopper.WeatherState.BY_ID.apply(this.ordinal() + 1);
        }
