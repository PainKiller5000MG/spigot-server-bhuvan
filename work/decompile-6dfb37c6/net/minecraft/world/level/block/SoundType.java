...
public class SoundType {
    ...
    public static final SoundType COPPER_GOLEM_STATUE = new SoundType(1.0F, 1.0F, SoundEvents.COPPER_GOLEM_STATUE_BREAK, SoundEvents.COPPER_GOLEM_STATUE_STEP, SoundEvents.COPPER_GOLEM_STATUE_PLACE, SoundEvents.COPPER_GOLEM_STATUE_HIT, SoundEvents.COPPER_GOLEM_STATUE_FALL);
    ...
    public static final SoundType SHELF = new SoundType(1.0F, 1.0F, SoundEvents.SHELF_BREAK, SoundEvents.SHELF_STEP, SoundEvents.SHELF_PLACE, SoundEvents.SHELF_HIT, SoundEvents.SHELF_FALL);
    ...
    public static final SoundType VAULT = new SoundType(1.0F, 1.0F, SoundEvents.VAULT_BREAK, SoundEvents.VAULT_STEP, SoundEvents.VAULT_PLACE, SoundEvents.VAULT_HIT, SoundEvents.VAULT_FALL);
    public static final SoundType CREAKING_HEART = new SoundType(1.0F, 1.0F, SoundEvents.CREAKING_HEART_BREAK, SoundEvents.CREAKING_HEART_STEP, SoundEvents.CREAKING_HEART_PLACE, SoundEvents.CREAKING_HEART_HIT, SoundEvents.CREAKING_HEART_FALL);
    public static final SoundType HEAVY_CORE = new SoundType(1.0F, 1.0F, SoundEvents.HEAVY_CORE_BREAK, SoundEvents.HEAVY_CORE_STEP, SoundEvents.HEAVY_CORE_PLACE, SoundEvents.HEAVY_CORE_HIT, SoundEvents.HEAVY_CORE_FALL);
    public static final SoundType COBWEB = new SoundType(1.0F, 1.0F, SoundEvents.COBWEB_BREAK, SoundEvents.COBWEB_STEP, SoundEvents.COBWEB_PLACE, SoundEvents.COBWEB_HIT, SoundEvents.COBWEB_FALL);
    public static final SoundType SPAWNER = new SoundType(1.0F, 1.0F, SoundEvents.SPAWNER_BREAK, SoundEvents.SPAWNER_STEP, SoundEvents.SPAWNER_PLACE, SoundEvents.SPAWNER_HIT, SoundEvents.SPAWNER_FALL);
    ...
    public static final SoundType RESIN_BRICKS = new SoundType(1.0F, 1.0F, SoundEvents.RESIN_BRICKS_BREAK, SoundEvents.RESIN_BRICKS_STEP, SoundEvents.RESIN_BRICKS_PLACE, SoundEvents.RESIN_BRICKS_HIT, SoundEvents.RESIN_BRICKS_FALL);
    public static final SoundType IRON = new SoundType(1.0F, 1.0F, SoundEvents.IRON_BREAK, SoundEvents.IRON_STEP, SoundEvents.IRON_PLACE, SoundEvents.IRON_HIT, SoundEvents.IRON_FALL);
    public static final SoundType DRIED_GHAST = new SoundType(1.0F, 1.0F, SoundEvents.DRIED_GHAST_BREAK, SoundEvents.DRIED_GHAST_STEP, SoundEvents.EMPTY, SoundEvents.EMPTY, SoundEvents.DRIED_GHAST_FALL);
