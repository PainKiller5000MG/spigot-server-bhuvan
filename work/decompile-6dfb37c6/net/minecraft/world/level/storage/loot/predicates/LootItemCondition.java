...
public interface LootItemCondition extends LootContextUser, Predicate<LootContext> {
    ...
    Codec<Holder<LootItemCondition>> CODEC = RegistryFileCodec.<Holder<LootItemCondition>>create(Registries.PREDICATE, LootItemCondition.DIRECT_CODEC);
    ...
    public interface Builder {
        ...
        default AnyOfCondition.Builder or(LootItemCondition.Builder other) {
            return AnyOfCondition.anyOf(this, other);
        }

        default AllOfCondition.Builder and(LootItemCondition.Builder other) {
