...
public class BuiltInLootTables {
    ...
    private static final Set<ResourceKey<LootTable>> IMMUTABLE_LOCATIONS = Collections.unmodifiableSet(BuiltInLootTables.LOCATIONS);
    ...
    private static Map<DyeColor, ResourceKey<LootTable>> makeDyeKeyMap(String prefix) {
        return Util.<DyeColor, ResourceKey<LootTable>>makeEnumMap(DyeColor.class, (dyecolor) -> {
            return register(prefix + "/" + dyecolor.getName());
        });
    }
    ...
    private static ResourceKey<LootTable> register(ResourceKey<LootTable> location) {
        if (BuiltInLootTables.LOCATIONS.add(location)) {
            return location;
        } else {
    ...
    public static Set<ResourceKey<LootTable>> all() {
        return BuiltInLootTables.IMMUTABLE_LOCATIONS;
    }
}
