...
public class SetItemDamageFunction extends LootItemConditionalFunction {
    ...
    public static final MapCodec<SetItemDamageFunction> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return commonFields(instance).and(instance.group(NumberProviders.CODEC.fieldOf("damage").forGetter((setitemdamagefunction) -> {
            return setitemdamagefunction.damage;
        }), Codec.BOOL.fieldOf("add").orElse(false).forGetter((setitemdamagefunction) -> {
            return setitemdamagefunction.add;
    ...
    public ItemStack run(ItemStack itemStack, LootContext context) {
        if (itemStack.isDamageableItem()) {
            ...
            SetItemDamageFunction.LOGGER.warn("Couldn't set damage of loot item {}", itemStack);
        }
    ...
    public static LootItemConditionalFunction.Builder<?> setDamage(NumberProvider value) {
        return simpleBuilder((list) -> {
            return new SetItemDamageFunction(list, value, false);
        });
    }

    public static LootItemConditionalFunction.Builder<?> setDamage(NumberProvider value, boolean add) {
        return simpleBuilder((list) -> {
            return new SetItemDamageFunction(list, value, add);
        });
    }
}
