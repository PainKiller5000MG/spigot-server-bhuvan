...
public class LootItemFunctions {
    ...
    public static final BiFunction<ItemStack, LootContext, ItemStack> IDENTITY = (itemstack, lootcontext) -> {
        return itemstack;
    };
    ...
    public static final Codec<Holder<LootItemFunction>> CODEC = RegistryFileCodec.<Holder<LootItemFunction>>create(Registries.ITEM_MODIFIER, LootItemFunctions.ROOT_CODEC);
    ...
    private static <T extends LootItemFunction> LootItemFunctionType<T> register(String name, MapCodec<T> codec) {
        return (LootItemFunctionType) Registry.register(BuiltInRegistries.LOOT_FUNCTION_TYPE, Identifier.withDefaultNamespace(name), new LootItemFunctionType(codec));
    }
    ...
    public static BiFunction<ItemStack, LootContext, ItemStack> compose(List<? extends BiFunction<ItemStack, LootContext, ItemStack>> functions) {
        List<BiFunction<ItemStack, LootContext, ItemStack>> list1 = List.copyOf(functions);
        ...
        switch (list1.size()) {
            ...
            case 1:
                ...
                break;
            case 2:
                BiFunction<ItemStack, LootContext, ItemStack> bifunction1 = (BiFunction) list1.get(0);
            ...
            default:
                bifunction = (itemstack, lootcontext) -> {
                    for (BiFunction<ItemStack, LootContext, ItemStack> bifunction3 : list1) {
                        itemstack = (ItemStack) bifunction3.apply(itemstack, lootcontext);
                    }
