...
public class ScoreboardNameProviders {
    ...
    private static LootScoreProviderType register(String name, MapCodec<? extends ScoreboardNameProvider> codec) {
        return (LootScoreProviderType) Registry.register(BuiltInRegistries.LOOT_SCORE_PROVIDER_TYPE, Identifier.withDefaultNamespace(name), new LootScoreProviderType(codec));
    }
}
