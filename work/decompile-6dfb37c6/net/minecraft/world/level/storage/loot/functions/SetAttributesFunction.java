...
public class SetAttributesFunction extends LootItemConditionalFunction {
    ...
    public static final MapCodec<SetAttributesFunction> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return commonFields(instance).and(instance.group(SetAttributesFunction.Modifier.CODEC.listOf().fieldOf("modifiers").forGetter((setattributesfunction) -> {
            return setattributesfunction.modifiers;
        }), Codec.BOOL.optionalFieldOf("replace", true).forGetter((setattributesfunction) -> {
            return setattributesfunction.replace;
    ...
    public Set<ContextKey<?>> getReferencedContextParams() {
        return (Set) this.modifiers.stream().flatMap((setattributesfunction_modifier) -> {
            return setattributesfunction_modifier.amount.getReferencedContextParams().stream();
    ...
    public ItemStack run(ItemStack itemStack, LootContext context) {
        if (this.replace) {
            ...
            itemStack.update(DataComponents.ATTRIBUTE_MODIFIERS, ItemAttributeModifiers.EMPTY, (itemattributemodifiers) -> {
                return this.updateModifiers(context, itemattributemodifiers);
            });
        }
    ...
    private ItemAttributeModifiers updateModifiers(LootContext context, ItemAttributeModifiers itemModifiers) {
        ...
        for (SetAttributesFunction.Modifier setattributesfunction_modifier : this.modifiers) {
            EquipmentSlotGroup equipmentslotgroup = (EquipmentSlotGroup) Util.getRandom(setattributesfunction_modifier.slots, randomsource);

            itemModifiers = itemModifiers.withModifierAdded(setattributesfunction_modifier.attribute, new AttributeModifier(setattributesfunction_modifier.id, (double) setattributesfunction_modifier.amount.getFloat(context), setattributesfunction_modifier.operation), equipmentslotgroup);
        }
    ...
    public static class Builder extends LootItemConditionalFunction.Builder<SetAttributesFunction.Builder> {
        ...
        public SetAttributesFunction.Builder withModifier(SetAttributesFunction.ModifierBuilder modifier) {
    ...
    private static record Modifier(Identifier id, Holder<Attribute> attribute, AttributeModifier.Operation operation, NumberProvider amount, List<EquipmentSlotGroup> slots) {
        ...
        public static final Codec<SetAttributesFunction.Modifier> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(Identifier.CODEC.fieldOf("id").forGetter(SetAttributesFunction.Modifier::id), Attribute.CODEC.fieldOf("attribute").forGetter(SetAttributesFunction.Modifier::attribute), AttributeModifier.Operation.CODEC.fieldOf("operation").forGetter(SetAttributesFunction.Modifier::operation), NumberProviders.CODEC.fieldOf("amount").forGetter(SetAttributesFunction.Modifier::amount), SetAttributesFunction.Modifier.SLOTS_CODEC.fieldOf("slot").forGetter(SetAttributesFunction.Modifier::slots)).apply(instance, SetAttributesFunction.Modifier::new);
        });
    }
}
