...
public record DamageSourceCondition(Optional<DamageSourcePredicate> predicate) implements LootItemCondition {
    ...
    public static final MapCodec<DamageSourceCondition> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(DamageSourcePredicate.CODEC.optionalFieldOf("predicate").forGetter(DamageSourceCondition::predicate)).apply(instance, DamageSourceCondition::new);
    });
    ...
    public boolean test(LootContext context) {
        ...
        return vec3 != null && damagesource != null ? this.predicate.isEmpty() || ((DamageSourcePredicate) this.predicate.get()).matches(context.getLevel(), vec3, damagesource) : false;
    }
