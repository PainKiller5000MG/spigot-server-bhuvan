...
public class LootItemConditions {
    ...
    private static LootItemConditionType register(String name, MapCodec<? extends LootItemCondition> codec) {
        return (LootItemConditionType) Registry.register(BuiltInRegistries.LOOT_CONDITION_TYPE, Identifier.withDefaultNamespace(name), new LootItemConditionType(codec));
    }
}
