...
public record WeatherCheck(Optional<Boolean> isRaining, Optional<Boolean> isThundering) implements LootItemCondition {
    ...
    public static final MapCodec<WeatherCheck> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(Codec.BOOL.optionalFieldOf("raining").forGetter(WeatherCheck::isRaining), Codec.BOOL.optionalFieldOf("thundering").forGetter(WeatherCheck::isThundering)).apply(instance, WeatherCheck::new);
    });
    ...
    public boolean test(LootContext context) {
        ...
        return this.isRaining.isPresent() && (Boolean) this.isRaining.get() != serverlevel.isRaining() ? false : !this.isThundering.isPresent() || (Boolean) this.isThundering.get() == serverlevel.isThundering();
    }
