...
public class NumberProviders {
    ...
    private static LootNumberProviderType register(String name, MapCodec<? extends NumberProvider> codec) {
        return (LootNumberProviderType) Registry.register(BuiltInRegistries.LOOT_NUMBER_PROVIDER_TYPE, Identifier.withDefaultNamespace(name), new LootNumberProviderType(codec));
    }
}
