...
public class EnchantWithLevelsFunction extends LootItemConditionalFunction {
    ...
    public static final MapCodec<EnchantWithLevelsFunction> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return commonFields(instance).and(instance.group(NumberProviders.CODEC.fieldOf("levels").forGetter((enchantwithlevelsfunction) -> {
            return enchantwithlevelsfunction.levels;
        }), RegistryCodecs.homogeneousList(Registries.ENCHANTMENT).optionalFieldOf("options").forGetter((enchantwithlevelsfunction) -> {
            return enchantwithlevelsfunction.options;
    ...
    public ItemStack run(ItemStack itemStack, LootContext context) {
        ...
        return EnchantmentHelper.enchantItem(randomsource, itemStack, this.levels.getInt(context), registryaccess, this.options);
    }

    public static EnchantWithLevelsFunction.Builder enchantWithLevels(HolderLookup.Provider registries, NumberProvider levels) {
        return (new EnchantWithLevelsFunction.Builder(levels)).fromOptions(registries.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(EnchantmentTags.ON_RANDOM_LOOT));
    }
    ...
    public static class Builder extends LootItemConditionalFunction.Builder<EnchantWithLevelsFunction.Builder> {
        ...
        public EnchantWithLevelsFunction.Builder fromOptions(HolderSet<Enchantment> tag) {
