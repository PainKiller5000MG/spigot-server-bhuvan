...
public class NbtProviders {
    ...
    private static LootNbtProviderType register(String name, MapCodec<? extends NbtProvider> codec) {
        return (LootNbtProviderType) Registry.register(BuiltInRegistries.LOOT_NBT_PROVIDER_TYPE, Identifier.withDefaultNamespace(name), new LootNbtProviderType(codec));
    }
}
