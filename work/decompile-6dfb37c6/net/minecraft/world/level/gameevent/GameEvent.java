...
public record GameEvent(int notificationRadius) {
    ...
    public static final Codec<Holder<GameEvent>> CODEC = RegistryFixedCodec.<Holder<GameEvent>>create(Registries.GAME_EVENT);
    ...
    public static record Context(@Nullable Entity sourceEntity, @Nullable BlockState affectedState) {
        ...
        public static GameEvent.Context of(@Nullable Entity sourceEntity) {
            return new GameEvent.Context(sourceEntity, (BlockState) null);
        }

        public static GameEvent.Context of(@Nullable BlockState state) {
            return new GameEvent.Context((Entity) null, state);
        }

        public static GameEvent.Context of(@Nullable Entity sourceEntity, @Nullable BlockState state) {
