...
public interface AttributeModifier<Subject, Argument> {
    ...
    public static enum OperationId implements StringRepresentable {
        ...
        OVERRIDE("override"), ALPHA_BLEND("alpha_blend"), ADD("add"), SUBTRACT("subtract"), MULTIPLY("multiply"), BLEND_TO_GRAY("blend_to_gray"), MINIMUM("minimum"), MAXIMUM("maximum"), AND("and"), NAND("nand"), OR("or"), NOR("nor"), XOR("xor"), XNOR("xnor");

        public static final Codec<AttributeModifier.OperationId> CODEC = StringRepresentable.<AttributeModifier.OperationId>fromEnum(AttributeModifier.OperationId::values);
