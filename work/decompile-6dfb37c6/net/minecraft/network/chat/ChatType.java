...
public record ChatType(ChatTypeDecoration chat, ChatTypeDecoration narration) {
    ...
    public static final Codec<ChatType> DIRECT_CODEC = RecordCodecBuilder.create((instance) -> {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, Holder<ChatType>> STREAM_CODEC = ByteBufCodecs.holder(Registries.CHAT_TYPE, ChatType.DIRECT_STREAM_CODEC);
    ...
    public static void bootstrap(BootstrapContext<ChatType> context) {
        context.register(ChatType.CHAT, new ChatType(ChatType.DEFAULT_CHAT_DECORATION, ChatTypeDecoration.withSender("chat.type.text.narrate")));
        context.register(ChatType.SAY_COMMAND, new ChatType(ChatTypeDecoration.withSender("chat.type.announcement"), ChatTypeDecoration.withSender("chat.type.text.narrate")));
        context.register(ChatType.MSG_COMMAND_INCOMING, new ChatType(ChatTypeDecoration.incomingDirectMessage("commands.message.display.incoming"), ChatTypeDecoration.withSender("chat.type.text.narrate")));
        context.register(ChatType.MSG_COMMAND_OUTGOING, new ChatType(ChatTypeDecoration.outgoingDirectMessage("commands.message.display.outgoing"), ChatTypeDecoration.withSender("chat.type.text.narrate")));
        context.register(ChatType.TEAM_MSG_COMMAND_INCOMING, new ChatType(ChatTypeDecoration.teamMessage("chat.type.team.text"), ChatTypeDecoration.withSender("chat.type.text.narrate")));
        context.register(ChatType.TEAM_MSG_COMMAND_OUTGOING, new ChatType(ChatTypeDecoration.teamMessage("chat.type.team.sent"), ChatTypeDecoration.withSender("chat.type.text.narrate")));
        context.register(ChatType.EMOTE_COMMAND, new ChatType(ChatTypeDecoration.withSender("chat.type.emote"), ChatTypeDecoration.withSender("chat.type.emote")));
    }

    public static ChatType.Bound bind(ResourceKey<ChatType> chatType, Entity entity) {
        return bind(chatType, entity.level().registryAccess(), entity.getDisplayName());
    }

    public static ChatType.Bound bind(ResourceKey<ChatType> chatType, CommandSourceStack source) {
        return bind(chatType, source.registryAccess(), source.getDisplayName());
    }

    public static ChatType.Bound bind(ResourceKey<ChatType> chatType, RegistryAccess registryAccess, Component name) {
    ...
    public static record Bound(Holder<ChatType> chatType, Component name, Optional<Component> targetName) {
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, ChatType.Bound> STREAM_CODEC = StreamCodec.composite(ChatType.STREAM_CODEC, ChatType.Bound::chatType, ComponentSerialization.TRUSTED_STREAM_CODEC, ChatType.Bound::name, ComponentSerialization.TRUSTED_OPTIONAL_STREAM_CODEC, ChatType.Bound::targetName, ChatType.Bound::new);
