...
public class LastSeenMessagesTracker {
    ...
    public void ignorePending(MessageSignature pendingMessage) {
        for (int i = 0; i < this.trackedMessages.length; ++i) {
            ...
            if (lastseentrackedentry != null && lastseentrackedentry.pending() && pendingMessage.equals(lastseentrackedentry.signature())) {
    ...
    public LastSeenMessagesTracker.Update generateAndApplyUpdate() {
        ...
        LastSeenMessages.Update lastseenmessages_update = new LastSeenMessages.Update(i, bitset, lastseenmessages.computeChecksum());
