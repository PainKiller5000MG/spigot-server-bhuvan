...
public class ClientboundResetChatPacket implements Packet<ClientConfigurationPacketListener> {
    ...
    public static final StreamCodec<ByteBuf, ClientboundResetChatPacket> STREAM_CODEC = StreamCodec.<ByteBuf, ClientboundResetChatPacket>unit(ClientboundResetChatPacket.INSTANCE);
