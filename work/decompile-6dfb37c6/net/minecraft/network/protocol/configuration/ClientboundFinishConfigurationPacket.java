...
public class ClientboundFinishConfigurationPacket implements Packet<ClientConfigurationPacketListener> {
    ...
    public static final StreamCodec<ByteBuf, ClientboundFinishConfigurationPacket> STREAM_CODEC = StreamCodec.<ByteBuf, ClientboundFinishConfigurationPacket>unit(ClientboundFinishConfigurationPacket.INSTANCE);
