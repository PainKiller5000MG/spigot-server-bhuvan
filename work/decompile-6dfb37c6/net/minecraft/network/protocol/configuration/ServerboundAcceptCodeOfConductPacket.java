...
public record ServerboundAcceptCodeOfConductPacket() implements Packet<ServerConfigurationPacketListener> {
    ...
    public static final StreamCodec<ByteBuf, ServerboundAcceptCodeOfConductPacket> STREAM_CODEC = StreamCodec.<ByteBuf, ServerboundAcceptCodeOfConductPacket>unit(ServerboundAcceptCodeOfConductPacket.INSTANCE);
