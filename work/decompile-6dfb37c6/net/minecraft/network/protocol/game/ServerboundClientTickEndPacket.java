...
public record ServerboundClientTickEndPacket() implements Packet<ServerGamePacketListener> {
    ...
    public static final StreamCodec<ByteBuf, ServerboundClientTickEndPacket> STREAM_CODEC = StreamCodec.<ByteBuf, ServerboundClientTickEndPacket>unit(ServerboundClientTickEndPacket.INSTANCE);
