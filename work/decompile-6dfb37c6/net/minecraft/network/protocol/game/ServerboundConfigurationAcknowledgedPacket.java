...
public class ServerboundConfigurationAcknowledgedPacket implements Packet<ServerGamePacketListener> {
    ...
    public static final StreamCodec<ByteBuf, ServerboundConfigurationAcknowledgedPacket> STREAM_CODEC = StreamCodec.<ByteBuf, ServerboundConfigurationAcknowledgedPacket>unit(ServerboundConfigurationAcknowledgedPacket.INSTANCE);
