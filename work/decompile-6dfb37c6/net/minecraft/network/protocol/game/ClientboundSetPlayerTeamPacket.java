...
public class ClientboundSetPlayerTeamPacket implements Packet<ClientGamePacketListener> {
    ...
    public static ClientboundSetPlayerTeamPacket createAddOrModifyPacket(PlayerTeam team, boolean createNew) {
        return new ClientboundSetPlayerTeamPacket(team.getName(), createNew ? 0 : 2, Optional.of(new ClientboundSetPlayerTeamPacket.Parameters(team)), (Collection) (createNew ? team.getPlayers() : ImmutableList.of()));
    }
    ...
    public ClientboundSetPlayerTeamPacket.@Nullable Action getPlayerAction() {
        ClientboundSetPlayerTeamPacket.Action clientboundsetplayerteampacket_action;

        switch (this.method) {
            case 0:
            case 3:
                clientboundsetplayerteampacket_action = ClientboundSetPlayerTeamPacket.Action.ADD;
                break;
            case 1:
            case 2:
            default:
                clientboundsetplayerteampacket_action = null;
                break;
            case 4:
                clientboundsetplayerteampacket_action = ClientboundSetPlayerTeamPacket.Action.REMOVE;
        }

        return clientboundsetplayerteampacket_action;
    }
