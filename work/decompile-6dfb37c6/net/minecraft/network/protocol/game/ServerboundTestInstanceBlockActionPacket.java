...
public record ServerboundTestInstanceBlockActionPacket(BlockPos pos, ServerboundTestInstanceBlockActionPacket.Action action, TestInstanceBlockEntity.Data data) implements Packet<ServerGamePacketListener> {
    ...
    public static enum Action {
        ...
        private static final IntFunction<ServerboundTestInstanceBlockActionPacket.Action> BY_ID = ByIdMap.<ServerboundTestInstanceBlockActionPacket.Action>continuous((serverboundtestinstanceblockactionpacket_action) -> {
            return serverboundtestinstanceblockactionpacket_action.id;
        }, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
        public static final StreamCodec<ByteBuf, ServerboundTestInstanceBlockActionPacket.Action> STREAM_CODEC = ByteBufCodecs.idMapper(ServerboundTestInstanceBlockActionPacket.Action.BY_ID, (serverboundtestinstanceblockactionpacket_action) -> {
            return serverboundtestinstanceblockactionpacket_action.id;
        });
