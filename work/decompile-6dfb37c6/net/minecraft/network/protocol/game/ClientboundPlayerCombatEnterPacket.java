...
public class ClientboundPlayerCombatEnterPacket implements Packet<ClientGamePacketListener> {
    ...
    public static final StreamCodec<ByteBuf, ClientboundPlayerCombatEnterPacket> STREAM_CODEC = StreamCodec.<ByteBuf, ClientboundPlayerCombatEnterPacket>unit(ClientboundPlayerCombatEnterPacket.INSTANCE);
