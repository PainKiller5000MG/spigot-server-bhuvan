...
public class ServerboundStatusRequestPacket implements Packet<ServerStatusPacketListener> {
    ...
    public static final StreamCodec<ByteBuf, ServerboundStatusRequestPacket> STREAM_CODEC = StreamCodec.<ByteBuf, ServerboundStatusRequestPacket>unit(ServerboundStatusRequestPacket.INSTANCE);
