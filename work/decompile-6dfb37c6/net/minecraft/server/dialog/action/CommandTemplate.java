...
public record CommandTemplate(ParsedTemplate template) implements Action {
    ...
    public static final MapCodec<CommandTemplate> MAP_CODEC = RecordCodecBuilder.mapCodec((instance) -> {
    ...
    public MapCodec<CommandTemplate> codec() {
        return CommandTemplate.MAP_CODEC;
    }

    @Override
    public Optional<ClickEvent> createAction(Map<String, Action.ValueGetter> parameters) {
        String s = this.template.instantiate(Action.ValueGetter.getAsTemplateSubstitutions(parameters));
