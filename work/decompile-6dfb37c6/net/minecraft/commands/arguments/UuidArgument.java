...
public class UuidArgument implements ArgumentType<UUID> {
    ...
    public UUID parse(StringReader reader) throws CommandSyntaxException {
        ...
        Matcher matcher = UuidArgument.ALLOWED_CHARACTERS.matcher(s);
        ...
        if (matcher.find()) {
            ...
            try {
                ...
                reader.setCursor(reader.getCursor() + s1.length());
                return uuid;
        ...
        throw UuidArgument.ERROR_INVALID_UUID.createWithContext(reader);
    }
