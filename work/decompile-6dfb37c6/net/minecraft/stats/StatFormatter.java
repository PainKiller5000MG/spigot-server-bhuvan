...
public interface StatFormatter {
    ...
    static {
        ...
        TIME = (i) -> {
            ...
            return d4 > 0.5D ? StatFormatter.DECIMAL_FORMAT.format(d4) + " y" : (d3 > 0.5D ? StatFormatter.DECIMAL_FORMAT.format(d3) + " d" : (d2 > 0.5D ? StatFormatter.DECIMAL_FORMAT.format(d2) + " h" : (d1 > 0.5D ? StatFormatter.DECIMAL_FORMAT.format(d1) + " min" : d0 + " s")));
        };
    }
}
