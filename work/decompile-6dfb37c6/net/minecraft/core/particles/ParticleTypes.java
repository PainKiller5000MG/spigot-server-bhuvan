...
public class ParticleTypes {
    ...
    public static final ParticleType<DustParticleOptions> DUST = register("dust", false, (particletype) -> {
        return DustParticleOptions.CODEC;
    }, (particletype) -> {
        return DustParticleOptions.STREAM_CODEC;
    });
    public static final ParticleType<DustColorTransitionOptions> DUST_COLOR_TRANSITION = register("dust_color_transition", false, (particletype) -> {
    ...
    public static final ParticleType<SculkChargeParticleOptions> SCULK_CHARGE = register("sculk_charge", true, (particletype) -> {
    ...
    public static final ParticleType<VibrationParticleOption> VIBRATION = register("vibration", true, (particletype) -> {
        return VibrationParticleOption.CODEC;
    }, (particletype) -> {
        return VibrationParticleOption.STREAM_CODEC;
    });
    public static final ParticleType<TrailParticleOption> TRAIL = register("trail", false, (particletype) -> {
    ...
    public static final ParticleType<ShriekParticleOption> SHRIEK = register("shriek", false, (particletype) -> {
    ...
    private static <T extends ParticleOptions> ParticleType<T> register(String name, boolean overrideLimiter, final Function<ParticleType<T>, MapCodec<T>> codec, final Function<ParticleType<T>, StreamCodec<? super RegistryFriendlyByteBuf, T>> streamCodec) {
        return (ParticleType) Registry.register(BuiltInRegistries.PARTICLE_TYPE, name, new ParticleType<T>(overrideLimiter) {
            @Override
