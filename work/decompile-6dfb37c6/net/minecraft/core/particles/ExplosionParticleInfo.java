...
public record ExplosionParticleInfo(ParticleOptions particle, float scaling, float speed) {
    ...
    public static final MapCodec<ExplosionParticleInfo> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
        return instance.group(ParticleTypes.CODEC.fieldOf("particle").forGetter(ExplosionParticleInfo::particle), Codec.FLOAT.optionalFieldOf("scaling", 1.0F).forGetter(ExplosionParticleInfo::scaling), Codec.FLOAT.optionalFieldOf("speed", 1.0F).forGetter(ExplosionParticleInfo::speed)).apply(instance, ExplosionParticleInfo::new);
    });
