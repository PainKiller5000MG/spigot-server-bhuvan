...
public interface DataComponentType<T> {
    ...
    StreamCodec<RegistryFriendlyByteBuf, DataComponentType<?>> STREAM_CODEC = StreamCodec.<RegistryFriendlyByteBuf, DataComponentType<?>>recursive((streamcodec) -> {
    ...
    static <T> DataComponentType.Builder<T> builder() {
        return new DataComponentType.Builder<T>();
    }
    ...
    public static class Builder<T> {
        ...
        public DataComponentType<T> build() {
            ...
            return new DataComponentType.Builder.SimpleType<T>(codec, streamcodec, this.ignoreSwapAnimation);
        }
