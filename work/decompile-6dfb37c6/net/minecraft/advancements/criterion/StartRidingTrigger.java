...
public class StartRidingTrigger extends SimpleCriterionTrigger<StartRidingTrigger.TriggerInstance> {
    ...
    public void trigger(ServerPlayer player) {
        this.trigger(player, (startridingtrigger_triggerinstance) -> {
            return true;
        });
    }
    ...
    public static record TriggerInstance(Optional<ContextAwarePredicate> player) implements SimpleCriterionTrigger.SimpleInstance {
        ...
        public static final Codec<StartRidingTrigger.TriggerInstance> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(EntityPredicate.ADVANCEMENT_CODEC.optionalFieldOf("player").forGetter(StartRidingTrigger.TriggerInstance::player)).apply(instance, StartRidingTrigger.TriggerInstance::new);
        });
