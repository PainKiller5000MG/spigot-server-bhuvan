...
public class PlayerTrigger extends SimpleCriterionTrigger<PlayerTrigger.TriggerInstance> {
    ...
    public void trigger(ServerPlayer player) {
        this.trigger(player, (playertrigger_triggerinstance) -> {
            return true;
        });
    }
    ...
    public static record TriggerInstance(Optional<ContextAwarePredicate> player) implements SimpleCriterionTrigger.SimpleInstance {
        ...
        public static final Codec<PlayerTrigger.TriggerInstance> CODEC = RecordCodecBuilder.create((instance) -> {
            return instance.group(EntityPredicate.ADVANCEMENT_CODEC.optionalFieldOf("player").forGetter(PlayerTrigger.TriggerInstance::player)).apply(instance, PlayerTrigger.TriggerInstance::new);
        });

        public static Criterion<PlayerTrigger.TriggerInstance> located(LocationPredicate.Builder location) {
        ...
        public static Criterion<PlayerTrigger.TriggerInstance> located(EntityPredicate.Builder player) {
        ...
        public static Criterion<PlayerTrigger.TriggerInstance> located(Optional<EntityPredicate> player) {
        ...
        public static Criterion<PlayerTrigger.TriggerInstance> walkOnBlockWithEquipment(HolderGetter<Block> blocks, HolderGetter<Item> items, Block stepOnBlock, Item requiredEquipment) {
