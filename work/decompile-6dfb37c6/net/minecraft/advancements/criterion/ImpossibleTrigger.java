...
public class ImpossibleTrigger implements CriterionTrigger<ImpossibleTrigger.TriggerInstance> {
    ...
    @Override
    public void addPlayerListener(PlayerAdvancements player, CriterionTrigger.Listener<ImpossibleTrigger.TriggerInstance> listener) {}

    @Override
    public void removePlayerListener(PlayerAdvancements player, CriterionTrigger.Listener<ImpossibleTrigger.TriggerInstance> listener) {}
