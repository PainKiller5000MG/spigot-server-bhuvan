...
public class EntityTheRenameningFix extends SimplestEntityRenameFix {
    ...
    protected String rename(String name) {
        ...
        return (String) EntityTheRenameningFix.RENAMED_IDS.getOrDefault(name, name);
    }
}
