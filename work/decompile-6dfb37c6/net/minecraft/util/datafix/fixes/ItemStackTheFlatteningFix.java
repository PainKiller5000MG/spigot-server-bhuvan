...
public class ItemStackTheFlatteningFix extends DataFix {
    ...
    public static @Nullable String updateItem(@Nullable String name, int data) {
        if (ItemStackTheFlatteningFix.IDS.contains(name)) {
            String s1 = (String) ItemStackTheFlatteningFix.MAP.get(name + "." + data);

            return s1 == null ? (String) ItemStackTheFlatteningFix.MAP.get(name + ".0") : s1;
        } else {
            return null;
        }
    }
