...
public class OptionsKeyLwjgl3Fix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("OptionsKeyLwjgl3Fix", this.getInputSchema().getType(References.OPTIONS), (typed) -> {
                    ...
                    return dynamic.createMap((Map) map.entrySet().stream().map((entry) -> {
                        if (((Dynamic) entry.getKey()).asString("").startsWith("key_")) {
                            ...
                            if (i < 0) {
                                ...
                                String s1 = (String) OptionsKeyLwjgl3Fix.MAP.getOrDefault(i, "key.unknown");
