...
public class LevelLegacyWorldGenSettingsFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("LevelLegacyWorldGenSettingsFix", this.getInputSchema().getType(References.LEVEL), (typed) -> {
            return typed.update(DSL.remainderFinder(), (dynamic) -> {
                Dynamic<?> dynamic1 = dynamic.get("WorldGenSettings").orElseEmptyMap();

                for (String s : LevelLegacyWorldGenSettingsFix.OLD_SETTINGS_KEYS) {
