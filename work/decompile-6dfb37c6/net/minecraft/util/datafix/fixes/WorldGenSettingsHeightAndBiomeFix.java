...
public class WorldGenSettingsHeightAndBiomeFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("WorldGenSettingsHeightAndBiomeFix", type, type1, (typed) -> {
            ...
            return typed.update(DSL.remainderFinder(), (dynamic) -> {
                ...
                return Util.writeAndReadTypedOrThrow(typed1, type2, (dynamic) -> {
                    return dynamic.update("minecraft:overworld", (dynamic1) -> {
    ...
    private static Dynamic<?> updateLayers(Dynamic<?> layers) {
        Dynamic<?> dynamic1 = layers.createMap(ImmutableMap.of(layers.createString("height"), layers.createInt(64), layers.createString("block"), layers.createString("minecraft:air")));

        return layers.createList(Stream.concat(Stream.of(dynamic1), layers.asStream()));
    }
}
