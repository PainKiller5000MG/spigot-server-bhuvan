...
public class ItemIdFix extends DataFix {
    ...
    public static String getItem(int id) {
        return (String) ItemIdFix.ITEM_NAMES.get(id);
    }
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(References.ITEM_STACK), this.getOutputSchema().getType(References.ITEM_STACK), (typed) -> {
            return typed.update(opticfinder, type1, (either) -> {
                return (Pair) either.map((integer) -> {
                    return Pair.of(References.ITEM_NAME.typeName(), getItem(integer));
                }, (pair) -> {
                    return pair;
                });
            });
