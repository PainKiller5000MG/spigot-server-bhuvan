...
public class ItemSpawnEggFix extends DataFix {
    ...
    public static final @Nullable String[] ID_TO_ENTITY = (String[]) DataFixUtils.make(new String[256], (astring) -> {
        astring[1] = "Item";
        astring[2] = "XPOrb";
        astring[7] = "ThrownEgg";
        astring[8] = "LeashKnot";
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemSpawnEggFix", type, (typed) -> {
            ...
            if (optional.isPresent() && Objects.equals(((Pair) optional.get()).getSecond(), "minecraft:spawn_egg")) {
                ...
                Typed<?> typed1 = typed;
                String s = ItemSpawnEggFix.ID_TO_ENTITY[short0 & 255];

                if (s != null && (optional4.isEmpty() || !Objects.equals(optional4.get(), s))) {
                    Typed<?> typed2 = typed.getOrCreateTyped(opticfinder2);
                    Dynamic<?> dynamic1 = (Dynamic) DataFixUtils.orElse(typed2.getOptionalTyped(opticfinder3).map((typed3) -> {
                        return (Dynamic) typed3.write().getOrThrow();
                    }), dynamic.emptyMap());
