...
public class RaidRenamesDataFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("RaidRenamesDataFix", this.getInputSchema().getType(References.SAVED_DATA_RAIDS), (typed) -> {
    ...
    private static Dynamic<?> fix(Dynamic<?> tag) {
        return tag.renameAndFixField("Raids", "raids", (dynamic1) -> {
