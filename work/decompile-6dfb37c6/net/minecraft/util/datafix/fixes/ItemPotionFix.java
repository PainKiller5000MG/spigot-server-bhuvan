...
public class ItemPotionFix extends DataFix {
    ...
    private static final @Nullable String[] POTIONS = (String[]) DataFixUtils.make(new String[128], (astring) -> {
            ...
            if (optional.isPresent() && Objects.equals(((Pair) optional.get()).getSecond(), "minecraft:potion")) {
                ...
                if (optional1.isPresent()) {
                    ...
                    if (optional2.isEmpty()) {
                        String s = ItemPotionFix.POTIONS[short0 & 127];
                        ...
                        if ((short0 & 16384) == 16384) {
                            typed1 = typed1.set(opticfinder, Pair.of(References.ITEM_NAME.typeName(), "minecraft:splash_potion"));
                        }
                    }
