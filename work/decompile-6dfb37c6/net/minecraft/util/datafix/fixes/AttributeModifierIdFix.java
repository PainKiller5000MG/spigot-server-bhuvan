...
public class AttributeModifierIdFix extends DataFix {
    ...
    private static Dynamic<?> convertModifierForEntity(Dynamic<?> modifier) {
        return modifier.renameField("UUID", "uuid").renameField("Name", "name").renameField("Amount", "amount").renameAndFixField("Operation", "operation", (dynamic1) -> {
            String s;
    ...
    private static Dynamic<?> fixItemStackComponents(Dynamic<?> components) {
        return components.update("minecraft:attribute_modifiers", (dynamic1) -> {
    ...
    private static Dynamic<?> fixAttribute(Dynamic<?> attribute) {
        return attribute.renameField("Name", "id").renameField("Base", "base").renameAndFixField("Modifiers", "modifiers", (dynamic1) -> {
            ...
            return (Dynamic) DataFixUtils.orElse(optional.map(attribute::createList), dynamic1);
        });
    }
