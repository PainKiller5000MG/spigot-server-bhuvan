...
public class EntityIdFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", type, type1), this.fixTypeEverywhere("EntityIdFix", taggedchoice_taggedchoicetype, taggedchoice_taggedchoicetype1, (dynamicops) -> {
            return (pair) -> {
                return pair.mapFirst((s) -> {
                    return (String) EntityIdFix.ID_MAP.getOrDefault(s, s);
                });
            };
        }));
    }
