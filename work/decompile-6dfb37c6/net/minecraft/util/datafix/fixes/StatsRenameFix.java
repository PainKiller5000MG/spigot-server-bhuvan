...
public class StatsRenameFix extends DataFix {
    ...
    private TypeRewriteRule createCriteriaRule() {
        ...
        TaggedChoice.TaggedChoiceType<?> taggedchoice_taggedchoicetype = (TaggedChoiceType) opticfinder.type().findChoiceType("type", -1).orElseThrow(() -> {
            return new IllegalStateException("Can't find choice type for criteria");
        });
        Type<?> type2 = (Type) taggedchoice_taggedchoicetype.types().get("minecraft:custom");
