            ...
            if (optional.isPresent() && Objects.equals(((Pair) optional.get()).getSecond(), "minecraft:shulker_box")) {
                ...
                if (optional1.isPresent()) {
                    ...
                    if (optional2.isPresent()) {
                        ...
                        return typed.set(opticfinder1, typed1.set(opticfinder2, typed2.set(DSL.remainderFinder(), dynamic))).set(opticfinder, Pair.of(References.ITEM_NAME.typeName(), ItemShulkerBoxColorFix.NAMES_BY_COLOR[i % 16]));
                    }
                }
            }
