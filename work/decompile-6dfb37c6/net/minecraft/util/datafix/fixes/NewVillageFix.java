...
public class NewVillageFix extends DataFix {
    ...
    private <SF> TypeRewriteRule cap(CompoundList.CompoundListType<String, SF> startsType) {
        ...
        OpticFinder<List<Pair<String, SF>>> opticfinder3 = startsType.finder();
        ...
        return TypeRewriteRule.seq(this.fixTypeEverywhereTyped("NewVillageFix", type, (typed) -> {
            ...
            return typed.update(DSL.remainderFinder(), (dynamic) -> {
                return dynamic.update("id", (dynamic1) -> {
                    return Objects.equals(NamespacedSchema.ensureNamespaced(dynamic1.asString("")), "minecraft:new_village") ? dynamic1.createString("minecraft:village") : dynamic1;
                });
            });
        }));
    }
