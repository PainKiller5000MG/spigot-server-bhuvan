    ...
    public TypeRewriteRule makeRule() {
        ...
        if (!(type2 instanceof List.ListType<?> list_listtype)) {
            ...
            if (!(type4 instanceof ListType)) {
                ...
                return TypeRewriteRule.seq((new AddNewChoices(this.getOutputSchema(), "AddTrappedChestFix", References.BLOCK_ENTITY)).makeRule(), this.fixTypeEverywhereTyped("Trapped Chest fix", type3, (typed) -> {
                        ...
                        if (optional.isEmpty()) {
                            ...
                            return typed1.updateTyped(opticfinder, (typed3) -> {
                                return typed3.updateTyped(taggedchoice_taggedchoicetype.finder(), (typed4) -> {
                                    ...
                                    return intset.contains(LeavesFix.getIndex(i1, j1, k1)) ? typed4.update(taggedchoice_taggedchoicetype.finder(), (pair) -> {
