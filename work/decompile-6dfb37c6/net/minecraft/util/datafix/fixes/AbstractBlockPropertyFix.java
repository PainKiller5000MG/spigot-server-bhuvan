...
public abstract class AbstractBlockPropertyFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped(this.name, this.getInputSchema().getType(References.BLOCK_STATE), (typed) -> {
    ...
    private Dynamic<?> fixBlockState(Dynamic<?> tag) {
        ...
        return optional.isPresent() && this.shouldFix((String) optional.get()) ? tag.update("Properties", (dynamic1) -> {
