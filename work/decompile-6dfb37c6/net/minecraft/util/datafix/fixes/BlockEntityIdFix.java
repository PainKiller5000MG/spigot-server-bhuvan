...
public class BlockEntityIdFix extends DataFix {
    ...
    public static final Map<String, String> ID_MAP = (Map) DataFixUtils.make(Maps.newHashMap(), (hashmap) -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(this.convertUnchecked("item stack block entity name hook converter", type, type1), this.fixTypeEverywhere("BlockEntityIdFix", taggedchoice_taggedchoicetype, taggedchoice_taggedchoicetype1, (dynamicops) -> {
            return (pair) -> {
                return pair.mapFirst((s) -> {
                    return (String) BlockEntityIdFix.ID_MAP.getOrDefault(s, s);
                });
            };
        }));
    }
