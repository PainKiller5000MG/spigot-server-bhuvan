...
public class V4302 extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
        ...
        schema.register(map, "minecraft:test_instance_block", () -> {
            return DSL.optionalFields("data", DSL.optionalFields("error_message", References.TEXT_COMPONENT.in(schema)), "errors", DSL.list(DSL.optionalFields("text", References.TEXT_COMPONENT.in(schema))));
        });
        return map;
    }
}
