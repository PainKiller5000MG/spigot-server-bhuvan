...
public class V3689 extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
        ...
        schema.register(map, "minecraft:trial_spawner", () -> {
            return DSL.optionalFields("spawn_potentials", DSL.list(DSL.fields("data", DSL.fields("entity", References.ENTITY_TREE.in(schema)))), "spawn_data", DSL.fields("entity", References.ENTITY_TREE.in(schema)));
        });
        return map;
    }
}
