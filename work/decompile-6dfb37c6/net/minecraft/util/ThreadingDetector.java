...
public class ThreadingDetector {
    ...
    public static ReportedException makeThreadingException(String name, @Nullable Thread threadThatFailedToAcquire) {
        String s1 = (String) Stream.of(Thread.currentThread(), threadThatFailedToAcquire).filter(Objects::nonNull).map(ThreadingDetector::stackTrace).collect(Collectors.joining("\n"));
        String s2 = "Accessing " + name + " from multiple threads";
        ...
        crashreportcategory.setDetail("Thread dumps", s1);
