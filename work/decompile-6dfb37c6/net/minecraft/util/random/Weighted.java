...
public record Weighted<T>(T value, int weight) {
    ...
    public static <E> Codec<Weighted<E>> codec(MapCodec<E> elementCodec) {
        return RecordCodecBuilder.create((instance) -> {
            return instance.group(elementCodec.forGetter(Weighted::value), ExtraCodecs.NON_NEGATIVE_INT.fieldOf("weight").forGetter(Weighted::weight)).apply(instance, Weighted::new);
        });
    }
